...
public class DefaultJnjb2bsvstoreService implements Jnjb2bsvstoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultJnjb2bsvstoreService.class);
