 ...
 */
package com.jnj.b2b.store.jalo;
...
import com.jnj.b2b.store.constants.Jnjb2bsvstoreConstants;



/**
 * This is the extension manager of the Jnjb2bsvstore extension.
 */
public class Jnjb2bsvstoreManager extends GeneratedJnjb2bsvstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Jnjb2bsvstoreManager.class);
	 ...
	 */
	public static Jnjb2bsvstoreManager getInstance()
	{
		return (Jnjb2bsvstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Jnjb2bsvstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjb2bsvstoreManager() // NOPMD 
	{
		LOG.debug("constructor of Jnjb2bsvstoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Jnjb2bsvstoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Jnjb2bsvstoreManager called, current tenant: {}", getTenant().getTenantID());
	}
