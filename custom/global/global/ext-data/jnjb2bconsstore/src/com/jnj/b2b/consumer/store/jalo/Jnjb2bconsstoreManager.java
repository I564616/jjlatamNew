 ...
 *  
 */
package com.jnj.b2b.consumer.store.jalo;
...
import com.jnj.b2b.consumer.store.constants.Jnjb2bconsstoreConstants;



/**
 * This is the extension manager of the Jnjb2bconsstore extension.
 */
public class Jnjb2bconsstoreManager extends GeneratedJnjb2bconsstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Jnjb2bconsstoreManager.class.getName());
	 ...
	 */
	public static Jnjb2bconsstoreManager getInstance()
	{
		return (Jnjb2bconsstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Jnjb2bconsstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjb2bconsstoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Jnjb2bconsstoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Jnjb2bconsstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Jnjb2bconsstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
