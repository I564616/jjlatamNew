 ...
 *
 */
package com.jnj.b2b.consumer.store.setup;
...
@SystemSetup(extension = "jnjb2bconsstore")
public class JnjB2BConsStoreSystemSetup extends AbstractSystemSetup
{

	private static final Logger LOG = Logger.getLogger(JnjB2BConsStoreSystemSetup.class);
	...
	protected static final String SYNC_CONS_CONT_STG_TO_ONLINE = "Sync-CONSContentStaged->CONSContentOnline";
	protected static final String SYNC_MSTR_CONT_STG_TO_CONS_CONT_STG = "Sync-MasterContentStaged->CONSContentCatalog";

	protected static final String SYNC_CONS_PROD_STG_TO_ONLINE = "Sync-CONSproductStaged->CONSproductOnline";


	protected static final String EPIC = "consumer";
	...
	{
		LOG.debug("Start jnjb2bconsstore-/consumerstore/import/common/countries.impex");
		importImpexFile(context, "/consumerstore/import/common/countries.impex");
		LOG.debug("End jnjb2bconsstore- /consumerstore/import/common/countries.impex");
		LOG.debug("Start jnjb2bconsstore-/consumerstore/import/common/essential-data.impex");
		importImpexFile(context, "/consumerstore/import/common/essential-data.impex");
		LOG.debug("End jnjb2bconsstore-/consumerstore/import/common/essential-data.impex");
		LOG.debug("Start jnjb2bconsstore-/consumerstore/import/common/themes.impex");
		//importImpexFile(context, "/consumerstore/import/consumer/delivery-modes.impex");
		importImpexFile(context, "/consumerstore/import/common/themes.impex");
		LOG.debug("End jnjb2bconsstore-/consumerstore/import/common/themes.impex");
		LOG.debug("Start jnjb2bconsstore-/consumerstore/import/common/unit.impex");
		importImpexFile(context, "/consumerstore/import/common/unit.impex");
		LOG.debug("End jnjb2bconsstore-/consumerstore/import/common/unit.impex");
		LOG.debug("Start jnjb2bconsstore-/consumerstore/import/common/configurations.impex");
		importImpexFile(context, "/consumerstore/import/common/configurations.impex");
		LOG.debug("End jnjb2bconsstore-/consumerstore/import/common/configurations.impex");
		LOG.debug("Start jnjb2bconsstore-/consumerstore/import/common/users.impex");
		importImpexFile(context, "/consumerstore/import/common/users.impex");
		LOG.debug("End jnjb2bconsstore-/consumerstore/import/common/users.impex");
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		if (importAccessRights && extensionNames.contains("jnjb2bconsstore"))
		{
			LOG.debug("Start -/consumerstore/import/common/users.impex");
			importImpexFile(context, "/consumerstore/import/common/users.impex");
			LOG.debug("End -/consumerstore/import/common/users.impex");
		}
		...
		{
			importImpexFile(context, "/consumerstore/import/consumer/cockpits/cmscockpit/cmscockpit-users.impex");
			importImpexFile(context, "/consumerstore/import/consumer/cockpits/cmscockpit/cmscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("btgcockpit"))
		{
			importImpexFile(context, "/consumerstore/import/consumer/cockpits/cmscockpit/btgcockpit-users.impex");
			importImpexFile(context, "/consumerstore/import/consumer/cockpits/cmscockpit/btgcockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("productcockpit"))
		{
			importImpexFile(context, "/consumerstore/import/consumer/cockpits/productcockpit/productcockpit-users.impex");
			importImpexFile(context, "/consumerstore/import/consumer/cockpits/productcockpit/productcockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("cscockpit"))
		{
			importImpexFile(context, "/consumerstore/import/consumer/cockpits/cscockpit/cscockpit-users.impex");
			importImpexFile(context, "/consumerstore/import/consumer/cockpits/cscockpit/cscockpit-access-rights.impex");
		}

		if (extensionNames.contains("mcc"))
		{
			//importImpexFile(context, "/consumerstore/import/common/mcc-sites-links.impex");
		}
	...
	public PerformResult executeCatalogSyncJob(final SystemSetupContext context, final String catalogName)
	{
		...
		if (syncContCatalogs || StringUtils.equals(catalogName, JNJ))
		{
			...
			/** MasterContent to CONSContentStaged */
			logInfo(context, "Executing catalogs sync job  [MasterContent to CONSContentStaged]");
			...
			logInfo(context, "Executed catalogs sync job  [MasterContent to CONSContentStaged] Status:- "
					+ syncMasterToCONSContentCronJob.getResult());

			if (StringUtils.equals(catalogName, JNJ))
			{
				importImpexFile(context, "/consumerstore/import/consumer/contentCatalogs/" + catalogName
			...
			if (!StringUtils.equals(catalogName, JNJ))
			{
				/** CONSContentStaged to CONSContentOnline */
				logInfo(context, "Executing catalogs sync job  [CONSContentStaged to CONSContentOnline]");
				final CronJobModel syncCONSContentStagedToOnlineCronJob = cronJobService.getCronJob(SYNC_CONS_CONT_STG_TO_ONLINE);
				((CatalogVersionSyncCronJobModel) syncCONSContentStagedToOnlineCronJob).setScheduleMedias(null);
				modelService.save(syncCONSContentStagedToOnlineCronJob);
				cronJobService.performCronJob(syncCONSContentStagedToOnlineCronJob, true);
				logInfo(context, "Executed catalogs sync job  [CONSContentStaged to CONSContentOnline] Status:- "
						+ syncCONSContentStagedToOnlineCronJob.getResult());
			}
		...
		if (syncProdCatalogs)
		{
			/** consProductStaged to consProductOnline */
			logInfo(context, "Executing catalogs sync job  [consProductStaged to consProductOnline]");
			final CronJobModel syncCONSProductStagedToOnlineCronJob = cronJobService.getCronJob(SYNC_CONS_PROD_STG_TO_ONLINE);
			((CatalogVersionSyncCronJobModel) syncCONSProductStagedToOnlineCronJob).setScheduleMedias(null);
			modelService.save(syncCONSProductStagedToOnlineCronJob);
			cronJobService.performCronJob(syncCONSProductStagedToOnlineCronJob, true);
			logInfo(context, "Executed catalogs sync job  [consProductStaged to consProductOnline] Status:- "
					+ syncCONSProductStagedToOnlineCronJob.getResult());
		}
	...
	protected void importProductCatalog(final SystemSetupContext context, final String catalogName, final String projectType)
	{
		...
		String prefix =  "/consumerstore/import/consumer/";
	...
	protected void createAndActivateSolrIndex(final SystemSetupContext context, final String storeName, final String projectType)
	{
		...
		importImpexFile(context, "/consumerstore/import/" + storeName + "/stores/" + projectType + "/solr.impex");
		importImpexFile(context, "/consumerstore/import/" + storeName + "/stores/" + projectType + "/solr_en.impex");

		logInfo(context, "Done SOLR index setup [" + storeName + " " + projectType + "]");
		
		logInfo(context, "Begin SOLR indexing --- [" + storeName + " " + projectType + "]");
		defaultSetupSolrIndexerService.executeSolrIndexerCronJob("jnjConsIndex", true);
	...
	protected void importContentCatalog(final SystemSetupContext context, final String catalogName, final String projectType)
	{
		...
		final boolean importGT = getBooleanSystemSetupParameter(context, IMPORT_GT);
		if(importGT){
		 logInfo(context, "Importing catalogs sync job  [MasterContent to CONSContentStaged]");
	...
	protected void importOrderStatus(final SystemSetupContext context)
	{
		...
		importImpexFile(context, "/consumerstore/import/consumer/order/orderStatusMapping.impex");
		importImpexFile(context, "/consumerstore/import/consumer/order/orderEntryStatusMapping.impex");
	...
	protected void importShippingMethods(final SystemSetupContext context)
	{
		...
		importImpexFile(context, "/consumerstore/import/consumer/order/shippingMethods.impex");
	...
	protected void importShipmentTrackingURLs(final SystemSetupContext context)
	{
		...
		importImpexFile(context, "/consumerstore/import/consumer/externaldata/shipmenttracking/shipmenttracking.impex");
	...
	protected void importCronJobs(final SystemSetupContext context, final String catalogName, final boolean active)
	{
		...
		//importImpexFile(context, "/consumerstore/import/common/JnjCronJobs.impex", true);
		if (active)
		{
			//importImpexFile(context, "/consumerstore/import/common/JnjCronJobsATriger.impex", true);
		}
		else
		{
			//importImpexFile(context, "/consumerstore/import/common/JnjCronJobsDTriger.impex", true);
		}
	...
	{
		logInfo(context, "Begin jnjb2bconsstore importing TestData [" + catalogName + "]");

		importImpexFile(context, "/consumerstore/import/consumer/externaldata/depuy/depuy-bonecement.impex");
		importImpexFile(context, "/consumerstore/import/consumer/externaldata/depuy/depuy-disposable.impex");
		importImpexFile(context, "/consumerstore/import/consumer/externaldata/depuy/depuy-extremities.impex");
		importImpexFile(context, "/consumerstore/import/consumer/externaldata/depuy/depuy-hips.impex");
		importImpexFile(context, "/consumerstore/import/consumer/externaldata/depuy/depuy-instdepuyspecific.impex");
		importImpexFile(context, "/consumerstore/import/consumer/externaldata/depuy/depuy-instgeneralpurpose.impex");
		importImpexFile(context, "/consumerstore/import/consumer/externaldata/depuy/depuy-knees.impex");
		importImpexFile(context, "/consumerstore/import/consumer/externaldata/depuy/depuy-lps.impex");
		importImpexFile(context, "/consumerstore/import/consumer/externaldata/depuy/depuy-ormedenvironmental.impex");
		importImpexFile(context, "/consumerstore/import/consumer/externaldata/depuy/depuy-shoulder.impex");

		logInfo(context, "Done jnjb2bconsstore importing TestData [" + catalogName + "]");
	}
