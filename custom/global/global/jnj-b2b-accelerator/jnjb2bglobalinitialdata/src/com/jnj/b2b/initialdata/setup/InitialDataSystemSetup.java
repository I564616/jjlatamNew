 ...
 *  
 */
package com.jnj.b2b.initialdata.setup;
...
import com.jnj.b2b.initialdata.constants.Jnjb2bglobalInitialDataConstants;
 ...
 */
@SystemSetup(extension = Jnjb2bglobalInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	protected static final String BTG_EXTENSION_NAME = "btg";

	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(InitialDataSystemSetup.class);

	protected static final String IMPORT_SAMPLE_DATA = "importSampleData";
	protected static final String SAMPLE_DATA_IMPORT_FOLDER = "b2bacceleratorsampledata";
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		// importCommonData(context, "jnjb2bglobalinitialdata");
		// This would import a standard store: (one basestore, one cmssite, one product catalog, one content catalog)
		// importStoreInitialData(context, "jnjb2bglobalinitialdata", "yb2baccelerator", "yb2baccelerator", Collections.singletonList("yb2baccelerator"));
	...
	protected void importProductCatalog(final SystemSetupContext context, final String importDirectory, final String catalogName)
	{
		...
		// Load Future Stock for  Products
		importImpexFile(context, "/" + importDirectory + "/import/productCatalogs/" + catalogName
				+ "ProductCatalog/products-futurestock.impex", false);
	}
