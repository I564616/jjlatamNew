 ...
 *
 */
package com.jnj.b2b.cockpits.productcockpit.editor;
...
{
	protected static final String EXTERNAL_TAXES_CNT_SCLASS = "externalTaxesEditor";
	protected static final String EXTERNAL_TAXES_SECTION = "externalTaxesSection";
	protected static final String EDITOR_SECTION_ROW_CNT_SCLASS = "externalTaxesRowComponent";
	protected static final String EDITOR_LABEL_CNT_SCLASS = "editorrowlabelcontainer";
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("jnjb2bglobalcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("jnjb2bglobalcockpits.product.externalTaxes"));
