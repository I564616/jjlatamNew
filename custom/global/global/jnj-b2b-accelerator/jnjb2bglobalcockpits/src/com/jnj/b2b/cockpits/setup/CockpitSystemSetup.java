 ...
 *
 */
package com.jnj.b2b.cockpits.setup;
...
import com.jnj.b2b.cockpits.constants.Jnjb2bglobalCockpitsConstants;
 ...
 */
@SystemSetup(extension = Jnjb2bglobalCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(Jnjb2bglobalCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(Jnjb2bglobalCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						Jnjb2bglobalCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/jnjb2bglobalcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
