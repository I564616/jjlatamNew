 ...
 *
 */
package com.jnj.b2b.cockpits.cmscockpit.sitewizard;
...
public class SummaryPage extends CmsSiteSummaryPage
{
	...
	protected static final String SUMMARY_ROW_SCLASS = "summaryRow";
	protected static final String SUMMARY_PAGE_CNT_SCLASS = "summaryPageCnt";

	protected static final String SITE_NAME_QUALIFIER = "siteName";
	protected static final String SITE_ACTIVE_QUALIFIER = "active";
	protected static final String SITE_STORES_QUALIFIER = "stores";
	protected static final String SITE_TEMPLATES_QUALIFIER = "templates";
	protected static final String SITE_CONTENTCATALOG_NAME_QUALIFIER = "contentcatalogname";
	protected static final String SITE_THEME_QUALIFIER = "theme";
	...
	protected static final String COCKPIT_ID_CREATEWEBSITE_SUMMARY_NAME_INPUT = "CreateWebsite_Summary_Name_input";
	protected static final String COCKPIT_ID_CREATEWEBSITE_SUMMARY_ACTIVE_INPUT = "CreateWebsite_Summary_Active_image";
	protected static final String COCKPIT_ID_CREATEWEBSITE_SUMMARY_BASESTORES_INPUT = "CreateWebsite_Summary_Basestores_input";
	protected static final String COCKPIT_ID_CREATEWEBSITE_SUMMARY_PAGETEMPLATES_INPUT = "CreateWebsite_Summary_Pagetemplates_input";
	protected static final String COCKPIT_ID_CREATEWEBSITE_SUMMARY_CONTENTCATALOGS_INPUT = "CreateWebsite_Summary_Contentcatalogs_input";
	protected static final String COCKPIT_ID_CREATEWEBSITE_SUMMARY_THEME_INPUT = "CreateWebsite_Summary_Theme_input";
