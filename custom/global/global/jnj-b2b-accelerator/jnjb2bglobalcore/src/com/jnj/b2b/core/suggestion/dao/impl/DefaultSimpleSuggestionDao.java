 ...
 *  
 */
package com.jnj.b2b.core.suggestion.dao.impl;
...
import com.jnj.b2b.core.suggestion.dao.SimpleSuggestionDao;
...
public class DefaultSimpleSuggestionDao extends AbstractItemDao implements SimpleSuggestionDao
{
	...
	protected static final String REF_QUERY_PARAM_CATEGORY = "category";
	protected static final String REF_QUERY_PARAM_USER = "user";
	protected static final String REF_QUERY_PARAM_TYPE = "referenceType";
	protected static final String REF_QUERY_PARAM_TYPES = "referenceTypes";

	protected static final String REF_QUERY_START = "SELECT {p.PK} FROM {Product AS p "
	...
	protected static final String REF_QUERY_TYPE = " AND {r.referenceType}=?referenceType";
	protected static final String REF_QUERY_TYPES = " AND {r.referenceType} IN (?referenceTypes)";
	protected static final String REF_QUERY_SUB = " AND NOT EXISTS (	{{"
			+ " SELECT 1 FROM {OrderEntry AS e2 LEFT JOIN Order AS o2 ON {e2.order}={o2.PK} } "
			+ " WHERE {e2.product}={r.target} AND {o2.user}=?user }}) ";
	protected static final String REF_QUERY_END = " ORDER BY {o.creationTime} DESC";
