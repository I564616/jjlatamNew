 ...
 *  
 */
package com.jnj.b2b.core.search.solrfacetsearch.provider.entity;
 ...
 * @Deprecated use {@link de.hybris.platform.b2bacceleratorfacades.search.solrfacetsearch.provider.entity.SolrPriceRange}
 */
@Deprecated
public class SolrPriceRange
{
	 ...
	 */
	protected SolrPriceRange(final SolrPriceRangeEntry lower, final SolrPriceRangeEntry higher)
	{
		super();
		this.lower = lower;
		this.higher = higher;
