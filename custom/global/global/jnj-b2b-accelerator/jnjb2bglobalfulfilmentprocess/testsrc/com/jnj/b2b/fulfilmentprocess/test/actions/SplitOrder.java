 ...
 *
 */
package com.jnj.b2b.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(Jnjb2bglobalFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Jnjb2bglobalFulfilmentProcessConstants.PARENT_PROCESS);
