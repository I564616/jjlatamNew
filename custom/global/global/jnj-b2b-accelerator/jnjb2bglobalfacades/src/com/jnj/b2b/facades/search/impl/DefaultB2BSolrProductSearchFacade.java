...
public class DefaultB2BSolrProductSearchFacade<ITEM extends ProductData> extends AbstractB2BProductSearchFacade<ITEM>
{
	...
	@Override
	public ProductSearchPageData<SearchStateData, ITEM> textSearch(String text, SearchQueryContext searchQueryContext)
	{
		return null;
	//	
	}
	@Override
	public ProductCategorySearchPageData<SearchStateData, ITEM, CategoryData> categorySearch(String text, SearchQueryContext searchQueryContext)
	{
		return null;
	//	
	}
