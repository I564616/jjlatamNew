 ...
 *  
 */
package com.jnj.b2b.storefront.controllers.cms;
...
public class ProductReferencesComponentController extends AbstractCMSComponentController<ProductReferencesComponentModel>
{
	...
	@Autowired
	protected JnjProductFacade jnjProductFacade;
	...
	protected void fillModel(final HttpServletRequest request, final Model model, final ProductReferencesComponentModel component)
	{
		...
		{
			final List<ProductReferenceData> productReferences = jnjProductFacade.getProductReferences(currentProduct.getCode(),
	...
	public JnjProductFacade getJnjProductFacade() {
		return jnjProductFacade;
	}

	public void setJnjProductFacade(JnjProductFacade jnjProductFacade) {
		this.jnjProductFacade = jnjProductFacade;
	}
}
