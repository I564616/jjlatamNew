...
import com.jnj.b2b.storefront.breadcrumb.impl.StoreBreadcrumbBuilder;
...
import com.jnj.b2b.storefront.forms.StoreFinderForm;
...
public class StorePageController extends AbstractPageController
{
	 ...
	 */
	protected static final String STORE_CODE_PATH_VARIABLE_PATTERN = "/{storeCode:.*}";
	protected static final String REDIRECT_STORE_FINDER = REDIRECT_PREFIX + "/store-finder";

	protected static final String STORE_FINDER_CMS_PAGE_LABEL = "storefinder";
	protected static final String GOOGLE_API_KEY_ID = "googleApiKey";
	protected static final String GOOGLE_API_VERSION = "googleApiVersion";
	...
	public StoreBreadcrumbBuilder getStoreBreadcrumbBuilder()
	{
		return storeBreadcrumbBuilder;
	}
