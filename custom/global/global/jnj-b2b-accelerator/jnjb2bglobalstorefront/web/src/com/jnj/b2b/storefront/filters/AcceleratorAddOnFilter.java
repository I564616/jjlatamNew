...
public class AcceleratorAddOnFilter extends GenericFilterBean
{
	...
	protected static final String DEFAULT_PLAIN_RESOURCE_PATTERN = "(.+)(/_ui/addons/)(.+)";
	protected static final String DEFAULT_EXECUTABLE_RESOURCE_PATTERN = "((.+/)(.+)/addons/)(.+)";
	protected static final String ADDON_FOLDER = "acceleratoraddon";
	...
	protected String getFullPathNameFromRequest(final HttpServletRequest request)
	{
		...
		final String realPath = FilenameUtils.normalize(request.getSession().getServletContext().getRealPath(requestUri));
		return realPath;
	}
