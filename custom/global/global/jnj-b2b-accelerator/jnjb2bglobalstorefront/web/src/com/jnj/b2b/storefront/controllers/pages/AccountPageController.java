...
import com.jnj.b2b.storefront.forms.AddressForm;
import com.jnj.b2b.storefront.forms.OrderApprovalDecisionForm;
import com.jnj.b2b.storefront.forms.QuoteOrderForm;
import com.jnj.b2b.storefront.forms.ReorderForm;
import com.jnj.b2b.storefront.forms.UpdateEmailForm;
import com.jnj.b2b.storefront.forms.UpdatePasswordForm;
import com.jnj.b2b.storefront.forms.UpdateProfileForm;
import com.jnj.b2b.storefront.forms.validation.B2BUpdatePasswordFormValidator;
 ...
 */
@Controller("jnjAccountPageController")
@Scope("tenant")
...
public class AccountPageController extends AbstractSearchPageController
{
	...
	protected static final String REDIRECT_TO_ADDRESS_BOOK_PAGE = REDIRECT_PREFIX + "/my-account/address-book";
	protected static final String REDIRECT_TO_PAYMENT_INFO_PAGE = REDIRECT_PREFIX + "/my-account/payment-details";
	protected static final String REDIRECT_TO_PROFILE_PAGE = REDIRECT_PREFIX + "/my-account/profile";
	protected static final String REDIRECT_TO_MYREPLENISHMENTS_PAGE = REDIRECT_PREFIX + "/my-account/my-replenishment";
	protected static final String REDIRECT_TO_MYREPLENISHMENTS_DETAIL_PAGE = REDIRECT_PREFIX + "/my-account/my-replenishment/%s/";
	...
	public VariantSortStrategy getVariantSortStrategy()
	{
		return variantSortStrategy;
	}

	public B2BUpdatePasswordFormValidator getB2bUpdatePasswordFormValidator()
	{
		return b2bUpdatePasswordFormValidator;
	}
