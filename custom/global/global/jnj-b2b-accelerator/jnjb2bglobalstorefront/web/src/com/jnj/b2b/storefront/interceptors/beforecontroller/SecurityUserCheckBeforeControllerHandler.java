...
public class SecurityUserCheckBeforeControllerHandler implements BeforeControllerHandler
{
	...
	@Value("${ajax.request.header.key}")
	private String ajaxRequestHeaderKey;

	@Value("${ajax.request.header.value}")
	private String ajaxRequestHeaderValue;

	@Value("${ajax.redirect.errorcode}")
	private String ajaxRedirectErrorCode;
