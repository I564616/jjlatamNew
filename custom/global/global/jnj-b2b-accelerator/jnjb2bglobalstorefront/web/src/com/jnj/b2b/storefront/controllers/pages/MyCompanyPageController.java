...
import com.jnj.b2b.storefront.forms.B2BPermissionForm;
import com.jnj.b2b.storefront.forms.validation.B2BBudgetFormValidator;
import com.jnj.b2b.storefront.forms.validation.B2BPermissionFormValidator;
...
public class MyCompanyPageController extends AbstractSearchPageController
{
	...
	/* @Resource(name = "b2bCommerceFacade")
	 ...
	 protected CostCenterFacade b2bCostCenterFacade1;*/   
	 @Resource(name = "costCenterFacade")
	...
	/*public CostCenterFacade getB2bCostCenterFacade()
	{
	...
	public B2BPermissionFormValidator getB2BPermissionFormValidator()
	{
		return b2BPermissionFormValidator;
	}

	public B2BBudgetFormValidator getB2BBudgetFormValidator()
	{
		return b2BBudgetFormValidator;
	}
	...
	{
		final List<CurrencyModel> currencies = (List<CurrencyModel>) commerceCommonI18NService.getAllCurrencies();
		  ...
		  return populateSelectBoxForString(currencyIsoCodeList);
	}
	...
	public List<SelectOption> getB2BPermissionTypes()
	{
		...
		final List<B2BPermissionTypeData> permissionTypeDatalist = (List<B2BPermissionTypeData>) b2bPermissionFacade.getB2BPermissionTypes();
	...
	public String myCompany(final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("unitUid", b2bUnitFacade.getParentUnit().getUid());
