...
public class CheckoutController extends AbstractCheckoutController
{
	...
	protected static final String JOB_CODE_PATH_VARIABLE_PATTERN = "{jobCode:.*}";

	protected static final String CHECKOUT_ORDER_CONFIRMATION_CMS_PAGE = "orderConfirmationPage";
	protected static final String ACCOUNT_REPLENISHMENT_PAGE = "/my-account/my-replenishment";
	...
	{
		final CheckoutFlowEnum checkoutFlow = getB2bCheckoutFlowFacade().getCheckoutFlow();
		if (CheckoutFlowEnum.MULTISTEP.equals(checkoutFlow))
		{
