...
import com.jnj.b2b.storefront.forms.FutureStockForm;
...
public class ProductPageController extends AbstractPageController
{
	...
	protected static final String REVIEWS_PATH_VARIABLE_PATTERN = "{numberOfReviews:.*}";

	protected static final String FUTURE_STOCK_ENABLED = "storefront.products.futurestock.enabled";
	protected static final String STOCK_SERVICE_UNAVAILABLE = "basket.page.viewFuture.unavailable";
	protected static final String NOT_MULTISKU_ITEM_ERROR = "basket.page.viewFuture.not.multisku";
	...
	public B2BFutureStockFacade getB2bFutureStockFacade()
	{
		return b2bFutureStockFacade;
	}
