...
public class CmsPageBeforeViewHandler implements BeforeViewHandler
{
	...
	protected static final String CSS_CODE_PREFIX = "page-";
	protected static final String CSS_LABEL_PREFIX = "pageLabel-";
	protected static final String CSS_TYPE_PREFIX = "pageType-";
	protected static final String CSS_TEMPLATE_PREFIX = "template-";
	...
	public Converter<RequestContextData, RestrictionData> getRequestContextRestrictionConverter()
	{
		return requestContextRestrictionConverter;
	}
