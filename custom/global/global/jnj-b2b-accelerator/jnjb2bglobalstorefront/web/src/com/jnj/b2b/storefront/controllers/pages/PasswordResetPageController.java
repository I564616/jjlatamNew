...
import com.jnj.b2b.storefront.forms.ForgottenPwdForm;
...
public class PasswordResetPageController extends AbstractPageController
{
	...
	@Resource(name = "b2bUpdatePwdFormValidator")
	protected B2BUpdatePwdFormValidator b2bUpdatePwdFormValidator;
	...
	public B2BUpdatePwdFormValidator getB2bUpdatePwdFormValidator()
	{
	...
	{
		b2bUpdatePwdFormValidator.validate(form, bindingResult);
		if (bindingResult.hasErrors())
		{
