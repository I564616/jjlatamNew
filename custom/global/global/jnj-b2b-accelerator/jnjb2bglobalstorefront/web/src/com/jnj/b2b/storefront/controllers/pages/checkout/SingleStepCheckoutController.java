 ...
 *
 */
package com.jnj.b2b.storefront.controllers.pages.checkout;
...
import com.jnj.b2b.storefront.forms.PaymentDetailsForm;
import com.jnj.b2b.storefront.forms.PlaceOrderForm;
import com.jnj.b2b.storefront.forms.validation.PaymentDetailsValidator;
...
public class SingleStepCheckoutController extends AbstractCheckoutController
{
	...
	protected static final String SINGLE_STEP_CHECKOUT_SUMMARY_CMS_PAGE = "singleStepCheckoutSummaryPage";
	...
	/*@Resource(name = "costCenterFacade")
	 ...
	 @Resource(name = "costCenterFacade")
	 private B2BCostCenterFacade  b2bCostCenterFacade;
	...
	public CartFacade getDoNotUsecartFacade()
	{
		return doNotUsecartFacade;
	}
	...
	{
		final List<? extends B2BCostCenterData> costCenterData = b2bCostCenterFacade.getActiveCostCenters();
