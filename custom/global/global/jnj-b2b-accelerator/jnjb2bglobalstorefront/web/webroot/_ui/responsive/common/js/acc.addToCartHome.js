	...
	/* Modified by Vijay Start*/			
		...
		/*Modified by Vijay End*/	
			...
			$(".addToCart").click(function(e){
				...
				var current_row = current_elem.closest('tr');
				var numberOfProdSelected = 0;
				var selectedProdCodes = [];
				
				var prodIndex = current_row.find('[name="index"]').val();
				var prodId_Qtys = current_row.find('[name="productCodePost"]').val()+":"+ $("#qty_desktop_"+prodIndex).val();
				selectedProdCodes.push(current_row.find('[name="productCodePost"]').val()); 
