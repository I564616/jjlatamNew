...

{
	...
	"cartPopupHtml": "<spring:escapeBody javaScriptEscape="true">
                        ...
                        <div style="display:none;" id="cart_popup" class="miniBasket cart_popup" ></div>
						<div class="sectionBlock body">
							...
							<div class="left marLeft10 marTop10">
								...
								<br />
								<p><b>Total items in <spring:message code="header.information.cart.${cartorderType}" />: </b> ${lines}</p>
							</div>
						</div>
