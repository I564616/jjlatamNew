 ...
 *
 */
package com.jnj.b2b.browseandsearch.jalo;
...
/**
 * This is the extension manager of the Jnjb2bbrowseandsearch extension.
 */
public class Jnjb2bbrowseandsearchManager extends GeneratedJnjb2bbrowseandsearchManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Jnjb2bbrowseandsearchManager.class.getName());
	 ...
	 */
	public static Jnjb2bbrowseandsearchManager getInstance()
	{
		return (Jnjb2bbrowseandsearchManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Jnjb2bbrowseandsearchConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjb2bbrowseandsearchManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Jnjb2bbrowseandsearchManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Jnjb2bbrowseandsearchManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Jnjb2bbrowseandsearchManager called, current tenant: " + getTenant().getTenantID());
		}
	}
