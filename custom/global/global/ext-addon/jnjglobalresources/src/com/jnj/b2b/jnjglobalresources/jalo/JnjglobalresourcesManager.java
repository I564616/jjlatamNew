 ...
 *
 */
package com.jnj.b2b.jnjglobalresources.jalo;
...
/**
 * This is the extension manager of the Jnjglobalresources extension.
 */
public class JnjglobalresourcesManager extends GeneratedJnjglobalresourcesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjglobalresourcesManager.class.getName());
	 ...
	 */
	public static JnjglobalresourcesManager getInstance()
	{
		return (JnjglobalresourcesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjglobalresourcesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjglobalresourcesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjglobalresourcesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjglobalresourcesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjglobalresourcesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
