				...
				<div class="row marginbottomipad25px">
					<div class="col-lg-12 col-md-12 col-sm-6 col-xs-12 start"><div>
						...
						<div class="input-group form-element form-element-date">
							...
							<form:input type="text" data-msg-required='' id="reports-startDate"  path="startDate" class="iconCalender date-picker form-control required"  name="toDate" 
							placeholder="${selDate}"/>
							 <label	for="reports-startDate" class="input-group-addon btn">
							 <span class="glyphicon glyphicon-calendar"></span> 
							 </label>
						</div>
						<div class="registerError"></div></div>
					</div>
					<div class="col-lg-12 col-md-12 col-sm-6 col-xs-12 margintop20px end"><div>
						...
						<div class="input-group form-element form-element-date">
							<form:input type="text" data-msg-required=""  name="toDate" placeholder="${selDate}"  path="endDate" id="reports-endDate" class="iconCalender  date-picker form-control required" />
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<label class="pull-left form-label form-label-select boldtext textheightipad reportslabelwidth getErrorMessage" for="productCode" class="getErrorMessage" data-msg-required="<spring:message code='reports.purchase.analysis.product.code.error' />"><spring:message code='reports.inventory.product.code' /><span class="redStar">*</span></label>
						 ...
						 <form:input  type="text" data-msg-required="" id="productCode" path="productCode" class=" form-control required"  style="width: 64%"/>
