...
<c:url value="/reports/orderAnalysis/multi" var="multiPurchaseURL" />
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="row form-mobile-row-gap">
						...
						<div class="input-group form-element form-element-date">
							...
							<input type="text"  name="startDate"  placeholder="Select date"   value="${startDate}" id="reports-startDate" path="startDate" class=" date-picker form-control required" />
					...
					<div
						...
						<div class="input-group form-element form-element-date">
							<!-- <input id="date-picker-1" name="toDate" placeholder="Select date" class="date-picker form-control" type="text"> -->
							<form:input type="text" name="toDate" placeholder="Select date"  data-msg-required="" value="${endDate}" path="endDate" id="reports-endDate" class=" date-picker form-control iconCalenderReport required" /> 
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<select id="operatingCompany" name="operatingCompany" class="form-control form-element form-element-select">
								...
								<c:choose>
									<c:when
										test="${not empty jnjGlobalMultiPurchaseAnalysisReportForm.operatingCompany && jnjGlobalMultiPurchaseAnalysisReportForm.operatingCompany eq franchise.code}">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margintop20px margintopipad20px orderedfrom">
						...
						<select id="orderedFrom" name="orderedFrom" 	class="form-control form-element form-element-select">
								...
								<c:forEach items="${orderedFrom}" var="orderValue">
									<c:choose>
										<c:when
											test="${orderValue.key eq JnjGTMultiPurchaseAnalysisReportForm.orderedFrom}">
