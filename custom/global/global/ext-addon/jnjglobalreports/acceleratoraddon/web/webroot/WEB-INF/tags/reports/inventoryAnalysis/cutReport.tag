...
<input type="hidden" id="hddnCurrentAccount" value="${currentAccountId}"/>
	...
	<form:form action="${cutReportUrl}" id="cutOrderReportForm" modelAttribute="cutReportForm" method="POST">
	...
	<form:input type="hidden" value="${currentAccountId}" id="hddnAccountsString" path="accountIdsList" />
		...
		<div class="row jnj-panel-body">
			<div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="row form-mobile-row-gap">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-row-gap start">
						<label class="pull-left form-label cut-report-label boldtext">
						<spring:message code="cutReport.startDate.label" />
							<span class="redStar">*</span>
						</label>
						<div class="input-group  input-append date"
							id="cutReportPoStartDate">
							<input type="text" id="postartDate" name="postartDate" placeholder="Select date" class="date-picker form-control required" /> 
							<label for="cut-report-startDate" class="input-group-addon btn">
					...
					<div
						...
						<label class="cut-report-label form-label boldtext">
						<spring:message code="cutReport.endDate.label" />
							<span class="redStar">*</span>
						</label>
						<div class="cut-report-field">
							<div class="input-group input-append date" id="cutReportPoEndDate">
								<input id="cut-report-endDate" name="poendDate" placeholder="Select date" class="date-picker form-control required" type="text">
								<label for="cut-report-endDate" class="input-group-addon btn">
									<span class="glyphicon glyphicon-calendar"></span> 
								</label>
							</div>
						</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="row form-mobile-row-gap">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-row-gap start">
						<label class="cut-report-label form-label boldtext">
							<spring:message code="cutReport.productCode.label" />
						</label>
						<div class="cut-report-field">
							<form:input class="form-control" id="productCode" path="productCode"></form:input>
						</div>
					</div>
					<div
						class="col-lg-12 col-md-12 col-sm-12 col-xs-12 end">
						<label class="cut-report-label form-label boldtext">
							<spring:message code="cutReport.ship.label" />
						</label>
						<div class="cut-report-field">
							<form:select class="selectshiptopicker" data-width="100%" id="shipTo" path="shipTo">
								<option>All</option>
							</form:select>
	...
	<div class="row jnj-panel-footer">
		<div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 link-holder">
			<span>
				<span class="link-txt boldtext">
					<spring:message code='reports.download.label' />
				</span> 
				<a href="#" id="cutOrderReportExcel" class="tertiarybtn marginRight excel">
					<spring:message code='reports.excel.label' />
				</a> 
				|<a href="#" id="cutOrderReportPdf" class="tertiarybtn pdf"> 
		...
		<div class="col-lg-6 col-md-8 col-sm-8 col-xs-12">
			<div class="pull-right btn-mobile">
				<a id="cutOrderReportSubmit" class="secondarybtn btn btnclsactive generatereport pull-right" href="#"> 
					<spring:message code='reports.search.labelUX' />
				</a>
				 <a class="tertiarybtn btn btnclsnormal reset" href="${cutReportUrl}">
		...
		<div class="col-lg-12 col-md-12">
			<div
				...
				<table id="datatab-desktop"
					class="table table-bordered table-striped sorting-table cut-report reports-table-desktop">
					<thead>
						<tr>
						...
						<c:forEach items="${cutReportOrders}" var="orderData">
							<c:forEach items="${orderData.cutReportEntries}"
								...
								<tr>
									...
									<td><span><c:if
												test="${not empty orderData.orderDate && orderData.orderDate ne null}"><!-- Modified by Archana for AAOL-5513 -->
									...
									<!-- <td>CS</td> -->
									<td><span><c:if
												test="${not empty cutReportDetails.availabilityDate && cutReportDetails.availabilityDate ne null}"><!-- Modified by Archana for AAOL-5513 -->
												<c:set var="dateformat"> <spring:message code='date.dateformat'/></c:set>
												<fmt:formatDate pattern="${dateformat}"
