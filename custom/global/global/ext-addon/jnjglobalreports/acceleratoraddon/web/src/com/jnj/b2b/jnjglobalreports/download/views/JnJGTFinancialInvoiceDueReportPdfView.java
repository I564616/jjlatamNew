...
public class JnJGTFinancialInvoiceDueReportPdfView extends AbstractPdfView{
				...
				final HttpServletRequest arg3, final HttpServletResponse arg4) throws Exception
		{
			try
			{
		       ...
		       events.onOpenDocument(arg2, arg1);  
				...
				arg4.setHeader("Content-Disposition", "attachment; filename=Invoice_Pase_Due.pdf");
				...
				invoicePastDueTable.addCell(createLabelCell("Invoice Due Date"));
				...
				if (null != jnjGTInvoicePastDueReportResponseDataList)
				{
					...
					for (final JnjGTInvoicePastDueReportResponseData jnjGTInvoicePastDueReportResponseData : jnjGTInvoicePastDueReportResponseDataList)
					{
						...
						invoicePastDueTable.addCell(createValueCell(jnjGTInvoicePastDueReportResponseData.getInvoiceDueDate() != null ? jnjGTInvoicePastDueReportResponseData.getInvoiceDueDate() :emptyField));
