 ...
 *
 */
package com.jnj.b2b.jnjglobalreports.jalo;
...
/**
 * This is the extension manager of the Jnjglobalreports extension.
 */
public class JnjglobalreportsManager extends GeneratedJnjglobalreportsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjglobalreportsManager.class.getName());
	 ...
	 */
	public static JnjglobalreportsManager getInstance()
	{
		return (JnjglobalreportsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjglobalreportsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjglobalreportsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjglobalreportsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjglobalreportsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjglobalreportsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
