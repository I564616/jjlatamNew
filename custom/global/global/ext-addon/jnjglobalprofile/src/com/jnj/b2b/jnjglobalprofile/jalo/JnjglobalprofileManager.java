 ...
 *
 */
package com.jnj.b2b.jnjglobalprofile.jalo;
...
/**
 * This is the extension manager of the Jnjglobalprofile extension.
 */
public class JnjglobalprofileManager extends GeneratedJnjglobalprofileManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjglobalprofileManager.class.getName());
	 ...
	 */
	public static JnjglobalprofileManager getInstance()
	{
		return (JnjglobalprofileManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjglobalprofileConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjglobalprofileManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjglobalprofileManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjglobalprofileManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjglobalprofileManager called, current tenant: " + getTenant().getTenantID());
		}
	}
