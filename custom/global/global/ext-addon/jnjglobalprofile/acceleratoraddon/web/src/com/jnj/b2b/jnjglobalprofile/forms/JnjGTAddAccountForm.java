 ...
 * 
 */
public class JnjGTAddAccountForm
{
	...
	private String nameOrNumberOfExistingAccount;
	private String anotherAccount;

	/**
	 * @return the anotherAccount
	 */
	 ...
	 *           the anotherAccount to set
	 */
	public void setAnotherAccount(final String anotherAccount)
	{
	...
	/**
	 * @return the nameOrNumberOfExistingAccount
	 */
	public String getNameOrNumberOfExistingAccount()
	{
		return nameOrNumberOfExistingAccount;
	}

	/**
	 * @param nameOrNumberOfExistingAccount
	 *           the nameOrNumberOfExistingAccount to set
	 */
	public void setNameOrNumberOfExistingAccount(final String nameOrNumberOfExistingAccount)
	{
		this.nameOrNumberOfExistingAccount = nameOrNumberOfExistingAccount;
	}
