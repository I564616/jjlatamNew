 ...
 *
 */
package com.jnj.b2b.cartandcheckoutaddon.jalo;
...
/**
 * This is the extension manager of the Cartandcheckoutaddon extension.
 */
public class CartandcheckoutaddonManager extends GeneratedCartandcheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CartandcheckoutaddonManager.class.getName());
	 ...
	 */
	public static CartandcheckoutaddonManager getInstance()
	{
		return (CartandcheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CartandcheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CartandcheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CartandcheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CartandcheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CartandcheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
