...
<%-- <div class="error" style="display: none;"  id="poNotPresent"><spring:message code="consignment.return.po.not.present"/></div> --%>
  ...
  <form:form id="consignmentReturnForm" action="cart/updateAll" method="post" commandName="consignmentReturnForm">
	<%-- <div class="col-lg-7 col-md-7 col-sm-4 col-xs-12"> 
		...
		<div class="txt-box-inline no-charge-select">
			...
			<span>
				<input id="customerPONo" type="text" name="customerPONo" class="form-control"  ${disabled}
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="pull-left form-consignment-input-select">
				...
				<input id="customerPONo" type="text" name="customerPONo" class="form-control"  value="${cartData.purchaseOrderNumber}"
					data-msg-required="<spring:message code="cart.common.purchaseOrder.enter" ></spring:message>" placeholder=""/>
	...
	<%-- <div class="col-lg-5 col-md-5 col-sm-4 col-xs-12 surgeon-name-holder">
		<div class="txt-label-inline">Stock User</div>
		<div class="txt-box-inline">
			<input type="text" id="dropShip" class="form-control"  name="dropShip"	value="${cartData.dropShipAccount}">
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margintop20px">
			...
			<div class="input-group form-element form-element-date">
				...
				<input id="poDate" name="poDate" placeholder="Start date" value="<fmt:formatDate pattern = "${dateformat}" value = "${cartData.poDate}" />" class="date-picker form-control" type="text" data-msg-required="<spring:message code="cart.common.poDate.enter" ></spring:message>">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margintop20px">
			<label class="pull-left boldtext label-lineHeight form-consignment-label-select"><spring:message code="return.created.date"/><span class="redStar">*</span></label>
			<div class="input-group form-element form-element-date">
			<c:set var="dateformat"> <spring:message code='date.dateformat'/></c:set>
				<input id="returnCreatedDate" name="returnCreatedDate" placeholder="Select date"  value="<fmt:formatDate pattern = "${dateformat}" value = "${cartData.returnCreatedDate}" />" class="date-picker form-control" type="text" data-msg-required="<spring:message code="cart.common.return.date.enter" ></spring:message>">
				<label for="returnCreatedDate" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span> </label>
			</div>	
			<div class="registerError" id="requestDelDateError"></div>
		</div>
	<%-- <div class="col-lg-5 col-md-5 col-sm-4 col-xs-12 surgeon-name-holder">
		<div class="txt-label-inline">Shipping Instructions</div>
		<div class="txt-box-inline">
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margintop20px">
			...
			<textarea class="form-control  form-consignment-input-select" rows="" id="comment"  name="comment" placeholder="">${cartData.shippingInstructions}</textarea>
		</div>
 </form:form>
