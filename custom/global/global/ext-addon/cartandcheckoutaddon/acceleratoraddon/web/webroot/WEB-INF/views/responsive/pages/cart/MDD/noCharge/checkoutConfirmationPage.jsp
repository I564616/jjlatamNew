			...
			<div class="row table-padding">
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
											...
											<div class="order-column50">
												<p class="subhead boldtext text-uppercase"><spring:message code="cart.confirmation.orderNumber" /></P>
												<div class="subtext boldtext"><a href="${orderDetailUrl}">${orderData.orderNumber}</a></div>
											</div>
											<div class="order-column50">
											...
											<div class="subtext boldtext"><label:message messageCode="${orderData.reasonCode}" /></div>
											</div>
