    ...
    <table id="datatab-desktop" class="table table-bordered table-striped sorting-table-lines fee-price-table">
      <thead>
        <tr>
          ...
          <th class="no-sort text-center text-uppercase"><spring:message code="cart.validate.product" /></th>
          <th class="no-sort text-center text-uppercase"><spring:message code="cart.validate.shippingMethod" /></th>
          ...
          <th class="no-sort total-thead fee-cell multitotal-thead  text-uppercase"><spring:message code="cart.validate.total" /></th>
        </tr>
      </thead>
      <tbody>
        <c:forEach items="${orderData.entries}" var="entry" varStatus="count">
          <tr id="orderentry-${count.count}">
            ...
            <td class="text-left"><standardCart:ProductDescriptionOrderComplete entry="${entry}" showRemoveLink="true" showStatus="false" /></td>
      ...
      <table id="datatab-mobile" class="table table-bordered table-striped sorting-table-lines">
        ...
        <tbody>
          <c:forEach items="${orderData.entries}" var="entry" varStatus="scount">
            <tr>
              <td class="text-left"><standardCart:ProductDescriptionOrderComplete rowcount="${scount.count}" entry="${entry}" showRemoveLink="true"
                  showStatus="false" />
        ...
        <td colspan='2'>
          <table id="fee-mobile-collpase" class="fee-collpase-table total-summary-table panel-collapse collapse">
            ...
            <tr>
              ...
              <td class="total-summary-cost totalrps" style="font-size: 12px !important"><format:price priceData="${orderData.totalminimumOrderFee}" /></td>
            </tr>
            <tr>
