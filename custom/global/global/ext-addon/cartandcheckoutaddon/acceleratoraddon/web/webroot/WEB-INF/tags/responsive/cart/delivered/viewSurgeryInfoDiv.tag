				...
				<div class="row surgery-info-row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 surgery-info-col">
						...
						<div>
							...
							<input type="text" readonly="readonly" value="<spring:message code="surgeryInfoPopup.surgerySpeciality.${cartData.surgeryInfo.surgerySpecialty}"/>" class="selectpicker form-control">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 surgery-info-col">
						...
						<div>
							...
							<input type="text" readonly="readonly" value ="<spring:message code="surgeryInfoPopup.levelsInstrumented.${cartData.surgeryInfo.levelsInstrumented}"/>" class="selectpicker form-control">
						</div>
				...
				<div class="row surgery-info-row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 surgery-info-col">
						...
						<div>
							...
							<input type="text" readonly="readonly" value ="<spring:message code="surgeryInfoPopup.orthobiologics.${cartData.surgeryInfo.orthobiologics}"/>" class="selectpicker form-control">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 surgery-info-col">
						...
						<div>
							...
							<input type="text" readonly="readonly" value ="<spring:message code="surgeryInfoPopup.pathology.${cartData.surgeryInfo.pathology}"/>" class="selectpicker form-control">
						</div>
					</div>
				</div>
				<div class="row surgery-info-row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 surgery-info-col">
						...
						<div class="surge-form-elem">
							...
							<input type="text" readonly="readonly" value ="<spring:message code="surgeryInfoPopup.surgicalApproach.${cartData.surgeryInfo.surgicalApproach}"/>" class="selectpicker form-control">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 surgery-info-col">
						...
						<div class="surge-form-elem">
							...
							<input type="text" readonly="readonly" value ="<spring:message code="surgeryInfoPopup.zone.${cartData.surgeryInfo.zone}"/>" class="selectpicker form-control">
						</div>
					</div>
				</div>
				<div class="row surgery-info-row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 surgery-info-col">
						...
						<div class="surge-form-elem">
							...
							<input type="text" readonly="readonly" value ="<spring:message code="surgeryInfoPopup.interbody.${cartData.surgeryInfo.interbody}"/>" class="selectpicker form-control">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 surgery-info-col">
						...
						<div class="surge-form-elem">
							<input type="text" id="caseNumber" name="caseNumber" readonly="readonly" class="form-control" value="${cartData.surgeryInfo.caseNumber}"/>							
						</div>
					</div>
				</div>
				<div class="row surgery-info-row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 surgery-info-col">
						...
						<div class="surge-form-elem">
							...
							<input type="text" readonly="readonly" value ="<spring:message code="surgeryInfoPopup.interbodyFusion.${cartData.surgeryInfo.interbodyFusion}"/>" class="selectpicker form-control">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 surgery-info-col">
						<div class="surge-label">
						...
						<div class="surge-form-elem">
							...
							<input type="text" readonly="readonly" value ="${cartData.surgeryInfo.caseDate}" class="selectpicker form-control">
						</div>
					</div>
				</div>
			</div>
