...
<!-- consignmentFillUp/checkoutConfirmationPage.jsp -->
  ...
  <div id="ordercompletePage" class="orderReviewpage">
    ...
    <div class="row table-padding">
      <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
        ...
        <div class="order-column50">
          <p class="subhead boldtext text-uppercase">
            <spring:message code="cart.common.requestedDeliveryDate" />
          </P>
          <div class="subtext boldtext">
        ...
        <div class="order-column50">
          ...
          <div class="subtext boldtext"><%-- ${orderData.statusDisplay} --%><spring:message code="text.account.order.status.display.open" /></div>
        </div>
        <div class="order-column50">
          <p class="subhead boldtext text-uppercase">
    ...
    <div class="row replishorder-row" style="padding: 20px 0;">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 replishment-download-link" style="margin-top: 10px;">
        ...
        <!-- AAOL-6018 changes start - Removal of Excel Download option -->
        ...
        <!-- AAOL-6018 changes ends -->
        <a  class="tertiarybtn pdf" href="${orderConfirmationDownload}?downloadType=PDF"> <spring:message code="cart.confirmation.pdf" /></a> </span>
      </div>
    </div>
    <br>
    <consignmentFillUpCart:orderEntries />
  </div>
</template:page>