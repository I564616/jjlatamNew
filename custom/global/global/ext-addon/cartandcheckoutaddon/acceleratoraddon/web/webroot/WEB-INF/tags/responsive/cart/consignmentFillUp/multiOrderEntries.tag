...
<!-- consignmentFillUp/multiOrderEntries.tag -->
    ...
    <div class="col-xs-12">
      <table id="datatab-mobile" class="table table-bordered table-striped sorting-table">
        ...
        <tbody>
          <c:forEach items="${jnjOrderData.entries}" var="entry" varStatus="count">
            <tr>
              <td class="text-left"><consignmentFillUpCart:ProductDescriptionOrderComplete entry="${entry}" showRemoveLink="true" showStatus="false" />
