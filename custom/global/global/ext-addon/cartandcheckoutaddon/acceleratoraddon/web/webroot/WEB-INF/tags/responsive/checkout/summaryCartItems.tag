...
<div class="item_container_holder">
	...
	<div class="item_container">
		<table id="your_cart">
			<thead>
				<tr>
					<th id="cartheader1"><span class="hidden"><spring:message code="order.product"/></span></th>
					<th id="cartheader2"><span class="hidden"><spring:message code="order.productDetails"/></span></th>
