						...
						<div class="row bottomrightbuttons">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="pull-right">
												<button type="button" class="btn btnclsnormal templatebtn saveorderastemplate"><spring:message code="cart.common.saveastemplate"/></button>
