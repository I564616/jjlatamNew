...
<div class="orderDetailPanel validateStandard"> 
			...
			<div class="hcolumn4"><ul class="ulCartEntry">
                <li class="textColorWhite"><label:message messageCode="cart.validate.quantity"/>
                </li><li class="textColorWhite"><a class="cartUpdateAllbtn" id="cartUpdateAllbutton" href="javascript:;"><spring:message code="cart.review.entry.Updateall"/></a></li></ul></div>
				...
				<div class="floatLeft column2">
                 ...
                 <div class="floatLeft column4">
						<div class="lbox">
							...
							<p><span >	<form:input disabled="${not entry.updateable}"  type="text" size="3"   maxlength="6" id="quantity${entry.entryNumber}" class="insertInput small qtyUpdateTextBox" entryNumber="${entry.entryNumber}" path="quantity"/></span></p>
							</ycommerce:testId>                              
