...
<!-- KIT Added -->
		<div class="addresspane">
			...
			<div class="row shipping-address">
				<div
					...
					<div>
						<label><spring:message code="cart.shipping.attention" />
							&nbsp; </label> <input type="text" name="attention" id="attention" maxlength="35"
							class="form-control textboxstyle ${addOnVisibilityCss}"
							${disabled} value="${cartData.attention}"></input>
					</div>
		...
		<div class="row">
			<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 hidden-xs">
				<div class=" float-right-to-none marginbtm30">
					<a href="javascript:;" class="anchorwhiteText continuetopayment btnclsactive btn"><spring:message
							code="cart.shipping.ContinuetoPayment" /></a>
				</div>
			</div>
		</div>	
		<deliveredCart:checkoutEntries />
		<div class="row">
			<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 hidden-xs">
				<div class=" float-right-to-none marginbtm30">
					<a href="javascript:;" class="anchorwhiteText continuetopayment btnclsactive btn"><spring:message
