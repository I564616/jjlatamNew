		...
		<div class="row">
			...
			<div class="btn-group btn-breadcrumb pull-right">
				<ul id="breadcrumbs-one">
					<li><a href="shipping" style="font-weight: bold;">1. <spring:message
								code="cart.shipping.header" /></a></li>
					<li><a href="#">2. <spring:message
								code="cart.shipping.payment" /></a></li>
					<li><a href="#">3. <spring:message
								code="cart.shipping.review" /></a></li>
				</ul>
			</div>
		</div>
		<!-- KIT Added -->
			...
			<div class="row shipping-address">
				<div
					...
					<div>
						...
						<label><spring:message code="cart.shipping.ImportantInstructions" />
							&nbsp; </label> 

					 	
						 
						<div class="attn-field">
							<input type="text" name="attention" id="attention" maxlength="40"

							class="form-control textboxstyle ${addOnVisibilityCss}"
							${disabled} value="${cartData.attention}" maxlength=35></input>
					</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-8">
						<div class="pull-right hypen">
							<strong class="fontsize30px"><format:price
									priceData="${cartData.subTotal}" /></strong>
						</div>
					</div>
				</div>
			</div>
