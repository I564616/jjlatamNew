					...
					<c:forEach items="${cartData.entries}" var="entry"
						...
						<tr id="orderentry-${count.count}">
							...
							<td class="text-left"><standardCart:productDescriptionBeforeValidation
									entry="${entry}" priceError="${priceValidationErrorMsg}" showRemoveLink="true" showStatus="false" /></td>
							<td class="valign-middle">
								<div class="cart-update-link">
									...
									id="updateCartForm${entry.entryNumber}_desktop"
			...
			<table id="datatab-mobile"
				...
				<tbody>
					<c:forEach items="${cartData.entries}" var="entry"
						...
						<tr>
							<td class="text-left"><standardCart:productDescriptionBeforeValidation
									entry="${entry}" priceError="${priceValidationErrorMsg}" rowcount="${count.count}"
					...
					<td colspan='2'>
						<table id="fee-mobile-collpase"
							...
							<tr>
								...
								<td class="total-summary-cost totalrps"
									style="font-size: 12px !important"><format:price
										priceData="${cartData.totalDropShipFee}" /></td>
							</tr>
							<tr>
								<td class="total-summary-label"
							...
							<tr>
								...
								<td class="total-summary-cost totalrps"
									style="font-size: 12px !important"><format:price
										priceData="${cartData.totalFreightFees}" /></td>
							</tr>
						</table>
					</td>
				</tr>
