			...
			<table id="datatab-desktop"
				...
				<thead>
					<tr>
						...
						<th class="no-sort"><spring:message	code="cart.shipping.product" /></th>						
						<th class="no-sort singleCartQuantity"><spring:message
						...
						<tr id="orderentry-${count.count}">
							...
							<td class="valign-middle totalrps fee-cell"
								id="totalPrice_${entry.entryNumber}"><ycommerce:testId
									...
									<span class="txt-nowrap"><format:price
											priceData="${entry.totalPrice}" /></span>
								</ycommerce:testId></td>
						</tr>
						...
						<c:if test="${freeGoodsMap ne null}">
							...
							<c:if test="${not empty valueObject.itemCategory}">
								<tr class="noborder">
									...
									<td class="valign-middle"><span class="txt-nowrap"><spring:message
												code="cart.freeitem.message" /></span></td>
									<td class="valign-middle"></td>
								</tr>
							</c:if>
						</c:if>
