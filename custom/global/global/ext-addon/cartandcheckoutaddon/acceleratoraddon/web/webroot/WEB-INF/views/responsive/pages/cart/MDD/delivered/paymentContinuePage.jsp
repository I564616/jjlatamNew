...
<template:page pageTitle="${pageTitle}">
								...
								<!-- Table collapse for mobile device-->
											<table id="ordersTable" class="table table-bordered table-striped tabsize">
																 <div class="panel-body details">																	
																	<div><label><spring:message code="cart.payment.purchageorder"/>&nbsp;</label> 
																	...
																	<h5>
																				<strong><spring:message code="cart.billtoAddress.header" /></strong>
																	</h5>
																	<h5>
								...
								<!--Accordian Ends here -->
										...
										<deliveredCart:paymentCartEntries/>
				...
				<input id="paymentErrorMsg" type="hidden" value="${reqErrorMsg}"/>
				<input id="orderType" type="hidden" value="${cartData.orderType}"/>			
