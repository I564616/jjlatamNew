...
<div class="row validatebtn">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="float-right-to-none">
	 				...
	 				<button type="button" class="btn btnclsactive replenishValidateSaveupdate ${classForValidate}" ><spring:message code="cart.review.progressBar.validate"/></button>
	 		</div>
		</div>
	</div> 