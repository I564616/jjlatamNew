		...
		<div class="modal-content popup">
			...
			<div class="modal-body">
				...
				<div class="radio radio-info">
					...
					<label for="keepItems"> <spring:message code="homePage.newOrder.keepItems"/></label>
				</div>
				<div class="radio radio-info">
					<input type="radio" name="newOrder" id="deleteItems" value="deleteItems"
						checked> <label for="deleteItems"><spring:message code="homePage.newReturn.deleteitems"/></label>
				</div>
			</div>
			<div class="modal-footer ftrcls">
				...
				<button type="button" class="btn btnclsactive" data-dismiss="modal"
					id="newOrderOk"><spring:message code="homePage.newReturn.ok"/></button>
			</div>
		</div>
	</form:form>	
	</div>
