...
<div class="productBox">
	<h3><spring:message code="homePage.orderTemplate.header"/></h3>
				...
				<c:choose>
					...
					<c:otherwise>
						<form:select class="marBott20" path="template" id="selTemplate" disabled="disabled">
							<option value="0"><spring:message code="homePage.orderTemplate.notemplateavailable"/></option>
						</form:select>
					</c:otherwise>
				</c:choose>
				<c:choose>
			...
			<c:choose>
				<c:when test="${not empty orderTemplates}">
					<div>
						...
						<input type="button" id="addToCartForm_3" value="<spring:message code="homePage.addtocart"/>"
					...
					<div class= "registersucess uploadMessagesSuccessOT hide">
					<label  class="success">
				...
				<c:otherwise>
					<div>
						<input type="submit" value="<spring:message code="homePage.view"/>" class="tertiarybtn left" disabled="disabled" />
						<input type="button" id="addToCartForm_3" value="<spring:message code="homePage.addtocart"/>" class="tertiarybtn right" />
					</div>
				</c:otherwise>
			</c:choose>
		</form:form>
