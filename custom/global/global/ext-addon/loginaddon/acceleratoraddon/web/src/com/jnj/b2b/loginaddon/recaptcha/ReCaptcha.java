...
public interface ReCaptcha
{
	...
	/**
	 * Creates HTML output with embedded recaptcha. The string response should be output on a HTML page (eg. inside a
	 * JSP).
	 * 
	 * @param errorMessage
	 *           An errormessage to display in the captcha, null if none.
	 * @param options
	 *           Options for rendering, <code>tabindex</code> and <code>theme</code> are currently supported by
	 *           recaptcha. You can put any options here though, and they will be added to the RecaptchaOptions
	 *           javascript array.
	 * @return
	 */
	 ...
	 * 
	 * @param errorMessage
	 *           The error message to show in the recaptcha ouput
	 * @param theme
	 ...
	 * @param challenge
	 *           The challenge from the reCaptcha form, this is usually request.getParameter("recaptcha_challenge_field")
	 *           in your code.
	 * @param response
	 *           The response from the reCaptcha form, this is usually request.getParameter("recaptcha_response_field")
	 *           in your code.
	 * @return
	 */
