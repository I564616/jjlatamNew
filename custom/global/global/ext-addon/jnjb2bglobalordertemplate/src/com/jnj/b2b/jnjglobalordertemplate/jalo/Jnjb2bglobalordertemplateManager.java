 ...
 *
 */
package com.jnj.b2b.jnjglobalordertemplate.jalo;
...
/**
 * This is the extension manager of the Jnjb2bglobalordertemplate extension.
 */
public class Jnjb2bglobalordertemplateManager extends GeneratedJnjb2bglobalordertemplateManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Jnjb2bglobalordertemplateManager.class.getName());
	 ...
	 */
	public static Jnjb2bglobalordertemplateManager getInstance()
	{
		return (Jnjb2bglobalordertemplateManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Jnjb2bglobalordertemplateConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjb2bglobalordertemplateManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Jnjb2bglobalordertemplateManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Jnjb2bglobalordertemplateManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Jnjb2bglobalordertemplateManager called, current tenant: " + getTenant().getTenantID());
		}
	}
