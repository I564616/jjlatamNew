												...
												<div class="help-accordian">
													...
													<div class="help-accordian-body panel-collapse collapse" id="collapse1">
															...
															<table id="datatab-desktop" class="table table-bordered table-striped">
																<thead>
																  <tr>
																	...
																	<th class="no-sort text-left text-uppercase"><spring:message code="dispute.order.overshipped.lot"/><spring:message code="dispute.order.overshipped.lot.separate"/></th>
																	<th class="no-sort text-uppercase"><spring:message code="dispute.order.overshipped.qty"/><spring:message code="dispute.order.overshipped.qty.received"/><sup class="star">*</sup></th>																	
																  </tr>
																</thead>
																<tbody>
																<c:forEach begin="0" end="4" varStatus="status"> 
																	<tr>
																		<td><input type="text" class="form-control prodCode medium productcode" id="prodCode_${status.index}" index="${status.index}" name="prodCode"></td>
																		<td><input type="text" class="form-control lotNumbers big " id="lotNumbers_${status.index}" index="${status.index}" name="lotNumbers"></td>
																		<td><input type="text" class="form-control prodQty small productcodeLast" id="prodQty_${status.index}" index="${status.index}" name="prodQty"></td>	
																	<td style="display:none;" class="emptyQtyError error" id="emptyQtyError_${status.index}"><spring:message code="dispute.order.overshipped.qty.errormessage"/></td>
																	</tr>
																</c:forEach>
																...
																<table id="datatab-mobile" class="table table-bordered table-striped">
																	...
																	<tbody>
																		...
																		<tr>
																			<td class="text-left">
																			<c:forEach begin="0" end="4" varStatus="status"> 
																				<a href="#collapse-tab-1" data-toggle="collapse" data-parent="#accordion" class="toggle-link panel-collapsed">																					
																					<span class="glyphicon glyphicon-plus"></span>
																					<span><spring:message code="orderDetailPage.orderData.productnumber"/></span>
																				</a>
																				<input type="text" class="form-control prodCode medium" id="prodCode_${status.index}" index="${status.index}" name="prodCode">																		
																					
																				<div id="collapse-tab-1" class="panel-collapse collapse sub-inputs">
																					<p class="text-uppercase"><spring:message code="dispute.order.overshipped.lot"/><spring:message code="dispute.order.overshipped.lot.separate"/></p>
																					<input type="text" class="form-control lotNumbers big" id="lotNumbers_${status.index}" index="${status.index}" name="lotNumbers">
																					<p class="text-uppercase margintop15"><spring:message code="dispute.order.overshipped.qty"/><spring:message code="dispute.order.overshipped.qty.received"/></p>
																					<input type="text" class="form-control prodQty small" id="prodQty_${status.index}" index="${status.index}" name="prodQty">																					
																				<div style="display:none;" class="emptyQtyError" id="emptyQtyError_${status.index}"><spring:message code="dispute.order.overshipped.qty.errormessage"/></div>
																				</div>
																			</c:forEach>	
																			</td>
																		</tr>
														...
														<div class="margintop10">
															...
															<form:radiobutton path="keepProductsShipped" id="productShipmentYes" value="true"/>
																<label for="dispute-yes">Yes</label>
															</div>
															<div class="radio radio-info radio-inline">
																<form:radiobutton path="keepProductsShipped" id="productShipmentNo" value="false"/>
												...
												<div class="help-accordian">
													...
													<div class="help-accordian-body panel-collapse collapse disputeFee" id="collapse2">
														<div class="checkbox checkbox-info checkboxmargin manual-checkbox ">
															<input type="checkbox" class="styled" name="manual" id="manual" value="Manual"/>
														...
														<div class="checkbox checkbox-info checkboxmargin margintop10">
															<input type="checkbox"  class="styled" name="minimum" id="minimum" value="Minimum"/>
															<!--<input type="hidden" name="disputedFees" id="disputedFees"/>  -->
															<label for="Minimum"><spring:message code="dispute.order.dispute.option2"/></label>
														</div>
														<div class="checkbox checkbox-info checkboxmargin margintop10">
															<input type="checkbox" class="styled" name="expedited" id="expedited" value="Expedited"/>
 														<!--	<input type="hidden" name="disputedFees" id="disputedFees"/>  -->
															<label for="Expedited"><spring:message code="dispute.order.dispute.option3"/></label>
														</div>
														<div class="checkbox checkbox-info checkboxmargin margintop10">
															<input type="checkbox" class="styled " name="shipping" id="shipping" value="Shipping & Handling/Freight"/>
 														<!--	<input type="hidden" name="disputedFees" id="disputedFees"/>  -->
