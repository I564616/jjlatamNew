			...
			<input type="hidden" id="totalResultsAccountSelection" value="${accountPaginationData.totalNumberOfResults}" />
				...
				<div class="modal-content" id="ContractDetailsPage">
						...
						<div class="form-group searchArea">
							<div class="search-txt-box">
								<input type="text" name="searchAccount" id="orderHisChangeAccountNoAjax"  value="${accountSearchTerm}" class="required changeContractSearch form-control searchBox"  placeholder="<spring:message code='change.account.search'/>"/>
							 	 <button class="glyphicon glyphicon-search searchBtn" id="orderHisSearchSelectAccountBtn" style="border: none;background: none"></button> 
							</div>
							<button class="btn btnclsactive searchbtn  primarybtn pull-right tertiarybtn clearSelectAccountBtn padding-30px" id="clearSelectAccountBtn"><spring:message code="popup.clear"/></button>
							  
							  
						 </div>	
						<%--  <button type="submit" class="btn btnclsactive searchbtn pull-right width20percent" id="accountsSubmit"><spring:message code='popup.send'/></button> --%>
					...
					<div class="row checbox-btn-row-history">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 for-landscape-mobile">
							<div class="float-right-to-none">
								 ...
								 <button type="submit" class="btn btnclsactive searchbtn pull-right padding-30px accountsSubmit" ><spring:message code='popup.send'/></button>
					...
					<div class="modalbody contract-detail-desktab modal-account-yscroll">
						...
						<div class="modal-footer ftrcls" style="border:none !important">
					...
					<div class="btn-mobile padding25">
						<button type="button" class="btn btnclsnormal slctaccount reset " data-dismiss="modal"><spring:message code='reports.account.selection.cancel' /></button>	

						<button type="submit" class="btn btnclsactive searchbtn pull-right padding-30px accountsSubmit" style="padding-right:20px;padding-left:20px;"><spring:message code='popup.send'/></button>
