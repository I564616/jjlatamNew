...
<div id="read_reviews">
	<ul class="review_actions">
		...
		<li>${fn:length(reviews)}&nbsp;<spring:theme code="review.number.of"/>&nbsp;${reviewsTotal}&nbsp;<spring:theme code="review.number.reviews"/></li>
		<c:if test="${fn:length(reviews) ne reviewsTotal}" >
		<li><a href="#" id="show_all_reviews_top_action"><spring:theme code="review.show.all"/></a></li>
		</c:if>
	</ul>
