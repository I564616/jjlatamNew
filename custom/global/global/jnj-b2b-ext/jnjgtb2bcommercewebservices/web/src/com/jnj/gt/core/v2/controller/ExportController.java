...
public class ExportController extends BaseController
{
	...
	@ResponseBody
	@Operation(summary = "Get a list of product exports.", description = "Used for product export. Depending on the timestamp parameter, it can return all products or only products modified after the given time.")
	@ApiBaseSiteIdParam
	public ProductListWsDTO exportProducts(
			...
			@Parameter(description = "The number of results returned per page.") @RequestParam(required = false, defaultValue = MAX_INTEGER) final int pageSize,
