...
public class CatalogsController extends BaseController
{
	...
	@ResponseBody
	@Operation(summary = "Get a list of catalogs", description = "Returns all catalogs with versions defined for the base store.")
	@ApiBaseSiteIdParam
	...
	@ResponseBody
	@Operation(summary = "Get a catalog", description = "Returns information about a catalog based on its ID, along with the versions defined for the current base store.")
	@ApiBaseSiteIdParam
	...
	@ResponseBody
	@Operation(summary = "Get information about catalog version", description = "Returns information about the catalog version that exists for the current base store.")
	@ApiBaseSiteIdParam
	...
	@ResponseBody
	@Operation(summary = "Get information about catagory in a catalog version", description = "Returns information about a specified category that exists in a catalog version available for the current base store.")
	@ApiBaseSiteIdParam
