...
/**
 * This is the extension manager of the Jnjgtb2boutboundservice extension.
 */
public class Jnjgtb2boutboundserviceManager extends GeneratedJnjgtb2boutboundserviceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Jnjgtb2boutboundserviceManager.class.getName());
	 ...
	 */
	public static Jnjgtb2boutboundserviceManager getInstance()
	{
		return (Jnjgtb2boutboundserviceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Jnjgtb2boutboundserviceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjgtb2boutboundserviceManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Jnjgtb2boutboundserviceManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Jnjgtb2boutboundserviceManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Jnjgtb2boutboundserviceManager called, current tenant: " + getTenant().getTenantID());
		}
	}
