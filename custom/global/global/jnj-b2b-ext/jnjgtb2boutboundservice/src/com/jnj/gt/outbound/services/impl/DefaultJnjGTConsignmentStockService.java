 ...
 *
 */
public class DefaultJnjGTConsignmentStockService implements JnjGTConsignmentStockService
{
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.jnj.core.outbound.services.JnjGTConsignmentStockService#viewConsignmentStocks(com.jnj.hcswmd01.
	 * mu007_epic_viewconsstock_v1.viewconsignmentstockwebservice.ViewConsignmentStockInput)
	 */
	@Override
	public ViewConsignmentStockOutput viewConsignmentStocks(final ViewConsignmentStockInput viewConsignmentStockInput)
			throws IntegrationException
	{
		final String MEHTOD_NAME = "viewConsignmentStocks()";
		...
		ViewConsignmentStockOutput viewConsignmentStockOutput = null;
		try
		{
			...
			jaxbContext = JAXBContext.newInstance(ViewConsignmentStockInput.class);
			marshaller = jaxbContext.createMarshaller();
			marshaller.marshal(viewConsignmentStockInput, System.out);
...

			{
				 ...
				 * (ViewConsignmentStockOutput) jaxbUnmarshaller.unmarshal(oldfile);
				 */
			...
			else
			{
				...
				viewConsignmentStockOutput = (ViewConsignmentStockOutput) ((JAXBElement) webserviceTemplateForConsignmentStock
						.marshalSendAndReceive(viewConsignmentStockInput, new WebServiceMessageCallback()
						{
							@Override
			...
			jaxbContext = JAXBContext.newInstance(ViewConsignmentStockOutput.class);
			marshaller = jaxbContext.createMarshaller();
