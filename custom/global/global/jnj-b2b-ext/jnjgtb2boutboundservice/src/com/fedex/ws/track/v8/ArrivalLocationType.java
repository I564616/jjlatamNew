...
/**
 * <p>
 * Java class for ArrivalLocationType.
 * 
 * <p>
...
@XmlEnum
@XmlRootElement(name = "ArrivalLocationType")
public enum ArrivalLocationType
{

	AIRPORT, CUSTOMER, CUSTOMS_BROKER, DELIVERY_LOCATION, DESTINATION_AIRPORT, DESTINATION_FEDEX_FACILITY, DROP_BOX, ENROUTE, FEDEX_FACILITY, FEDEX_OFFICE_LOCATION, INTERLINE_CARRIER, NON_FEDEX_FACILITY, ORIGIN_AIRPORT, ORIGIN_FEDEX_FACILITY, PICKUP_LOCATION, PLANE, PORT_OF_ENTRY, SORT_FACILITY, TURNPOINT, VEHICLE;
	...
	public static ArrivalLocationType fromValue(final String v)
	{
		return valueOf(v);
	}
