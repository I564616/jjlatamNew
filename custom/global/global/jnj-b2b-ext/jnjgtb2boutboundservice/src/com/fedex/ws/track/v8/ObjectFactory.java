 ...
 * generated in the com.fedex.ws.track.v8 package. 
...
public class ObjectFactory {
    ...
    private final static QName _TrackReply_QNAME = new QName("http://fedex.com/ws/track/v8", "TrackReply");
    private final static QName _SendNotificationsRequest_QNAME = new QName("http://fedex.com/ws/track/v8", "SendNotificationsRequest");
    private final static QName _SendNotificationsReply_QNAME = new QName("http://fedex.com/ws/track/v8", "SendNotificationsReply");
    private final static QName _SignatureProofOfDeliveryLetterReply_QNAME = new QName("http://fedex.com/ws/track/v8", "SignatureProofOfDeliveryLetterReply");
    private final static QName _SignatureProofOfDeliveryFaxReply_QNAME = new QName("http://fedex.com/ws/track/v8", "SignatureProofOfDeliveryFaxReply");
    private final static QName _SignatureProofOfDeliveryFaxRequest_QNAME = new QName("http://fedex.com/ws/track/v8", "SignatureProofOfDeliveryFaxRequest");
    private final static QName _TrackRequest_QNAME = new QName("http://fedex.com/ws/track/v8", "TrackRequest");
    private final static QName _SignatureProofOfDeliveryLetterRequest_QNAME = new QName("http://fedex.com/ws/track/v8", "SignatureProofOfDeliveryLetterRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.fedex.ws.track.v8
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v8", name = "TrackReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v8", name = "SendNotificationsRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v8", name = "SendNotificationsReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v8", name = "SignatureProofOfDeliveryLetterReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v8", name = "SignatureProofOfDeliveryFaxReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v8", name = "SignatureProofOfDeliveryFaxRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v8", name = "TrackRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v8", name = "SignatureProofOfDeliveryLetterRequest")
