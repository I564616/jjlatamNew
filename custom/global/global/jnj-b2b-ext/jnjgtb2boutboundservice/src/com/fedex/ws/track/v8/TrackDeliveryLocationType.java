...
/**
 * <p>
 * Java class for TrackDeliveryLocationType.
 * 
 * <p>
...
@XmlEnum
@XmlRootElement(name = "TrackDeliveryLocationType")
public enum TrackDeliveryLocationType
{

	APARTMENT_OFFICE, FEDEX_LOCATION, GATE_HOUSE, GUARD_OR_SECURITY_STATION, IN_BOND_OR_CAGE, LEASING_OFFICE, MAILROOM, MAIN_OFFICE, MANAGER_OFFICE, OTHER, PHARMACY, RECEPTIONIST_OR_FRONT_DESK, RENTAL_OFFICE, RESIDENCE, SHIPPING_RECEIVING;
	...
	public static TrackDeliveryLocationType fromValue(final String v)
	{
		return valueOf(v);
	}
