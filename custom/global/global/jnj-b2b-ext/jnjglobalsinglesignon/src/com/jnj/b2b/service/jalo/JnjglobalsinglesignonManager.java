 ...
 */
package com.jnj.b2b.service.jalo;
...
import com.jnj.b2b.service.constants.JnjglobalsinglesignonConstants;



/**
 * This is the extension manager of the Jnjglobalsinglesignon extension.
 */
public class JnjglobalsinglesignonManager extends GeneratedJnjglobalsinglesignonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjglobalsinglesignonManager.class.getName());
	 ...
	 */
	public static JnjglobalsinglesignonManager getInstance()
	{
		return (JnjglobalsinglesignonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjglobalsinglesignonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjglobalsinglesignonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjglobalsinglesignonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjglobalsinglesignonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjglobalsinglesignonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
