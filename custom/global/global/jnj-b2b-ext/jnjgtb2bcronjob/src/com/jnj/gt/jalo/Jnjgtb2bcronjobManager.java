...
/**
 * This is the extension manager of the Jnjgtb2bcronjob extension.
 */
public class Jnjgtb2bcronjobManager extends GeneratedJnjgtb2bcronjobManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Jnjgtb2bcronjobManager.class.getName());
	 ...
	 */
	public static Jnjgtb2bcronjobManager getInstance()
	{
		return (Jnjgtb2bcronjobManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Jnjgtb2bcronjobConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjgtb2bcronjobManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Jnjgtb2bcronjobManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Jnjgtb2bcronjobManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Jnjgtb2bcronjobManager called, current tenant: " + getTenant().getTenantID());
		}
	}
