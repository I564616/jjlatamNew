 ...
 *  
 */
package de.hybris.platform.jnjb2boutboundservice.jalo;
...
/**
 * This is the extension manager of the Jnjb2boutboundservice extension.
 */
public class Jnjb2boutboundserviceManager extends GeneratedJnjb2boutboundserviceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Jnjb2boutboundserviceManager.class.getName());
	 ...
	 */
	public static Jnjb2boutboundserviceManager getInstance()
	{
		return (Jnjb2boutboundserviceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Jnjb2boutboundserviceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjb2boutboundserviceManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Jnjb2boutboundserviceManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Jnjb2boutboundserviceManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Jnjb2boutboundserviceManager called, current tenant: " + getTenant().getTenantID());
		}
	}
