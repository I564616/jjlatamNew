 ...
 *         &lt;element name="IndirectPayerAcct" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="PriceOverrideRate" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="PriceOverrideReason" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
public class InOrderLines {
    ...
    @XmlElementRef(name = "IndirectPayerAcct", type = JAXBElement.class, required = false)
    protected JAXBElement<String> indirectPayerAcct;
    @XmlElementRef(name = "PriceOverrideRate", type = JAXBElement.class, required = false)
    protected JAXBElement<String> priceOverrideRate;
    @XmlElement(name = "PriceOverrideReason", required = true)
     ...
     *     
     */
    public void setIndirectCustomerAcct(JAXBElement<String> value) {
        this.indirectCustomerAcct = value;
    }

    /**
     * Gets the value of the indirectPayerAcct property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getIndirectPayerAcct() {
        return indirectPayerAcct;
    }

    /**
     * Sets the value of the indirectPayerAcct property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setIndirectPayerAcct(JAXBElement<String> value) {
        this.indirectPayerAcct = value;
    }
     ...
     *     
     */
    public void setPriceOverrideRate(JAXBElement<String> value) {
     ...
     *     
     */
    public void setExpectedPriceRate(JAXBElement<String> value) {
