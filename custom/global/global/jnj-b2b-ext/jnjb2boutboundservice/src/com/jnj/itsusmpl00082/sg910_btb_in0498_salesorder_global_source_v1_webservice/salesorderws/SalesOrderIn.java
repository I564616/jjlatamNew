 ...
 *         &lt;element name="in_Incoterms" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
{ "inRequestType", "inSalesOrganization", "inDistributionChannel", "inDivision", "inOrderType", "inSoldToNumber",
		"inShipToNumber", "inCustomerPortalOrdernumber", "inPONumber", "inComplementaryInfo", "inSourceInfo", "inOrderChannel", "inOrderReason", "inContactName",
		"inContactPhoneNumber", "inContactEmail", "inRequestedDeliveryDate", "inCompleteDelivery", "inForbiddenSales",
		"inContractReferenceNumber", "inOrderLines", "inIncoterms" })
...
public class SalesOrderIn
{
	...
	@XmlElementRef(name = "in_ComplementaryInfo", type = JAXBElement.class, required = false)
	protected JAXBElement<String> inComplementaryInfo;
	@XmlElementRef(name = "in_SourceInfo", type = JAXBElement.class, required = true)
	protected JAXBElement<String> inSourceInfo;
	...
	@XmlElementRef(name = "in_Incoterms", type = JAXBElement.class, required = false)
	protected JAXBElement<String> inIncoterms;
	...
	/**
	 * Gets the value of the inComplementaryInfo property.
	 *
	 * @return possible object is {@link JAXBElement }{@code <}{@link String }{@code >}
	 *
	 */
	public JAXBElement<String> getInComplementaryInfo()
	{
		return inComplementaryInfo;
	}

	/**
	 * Sets the value of the inComplementaryInfo property.
	 *
	 * @param value
	 * allowed object is {@link JAXBElement }{@code <}{@link String }{@code >}
	 *
	 */
	public void setInComplementaryInfo(final JAXBElement<String> value)
	{
		this.inComplementaryInfo = value;
	}
	
	/**
	 * @return the inSourceInfo
	 */
	public JAXBElement<String> getInSourceInfo() {
		return inSourceInfo;
	}

	/**
	 * @param inSourceInfo the inSourceInfo to set
	 */
	public void setInSourceInfo(JAXBElement<String> inSourceInfo) {
		this.inSourceInfo = inSourceInfo;
	}

	/**
	 * @param inOrderLines the inOrderLines to set
	 */
	public void setInOrderLines(List<InOrderLines> inOrderLines) {
	...
	/**
	 * Gets the value of the inIncoterms property.
	 * 
	 * @return possible object is {@link JAXBElement }{@code <}{@link String }{@code >}
	 * 
	 */
	public JAXBElement<String> getInIncoterms()
	{
		return inIncoterms;
	}

	/**
	 * Sets the value of the inIncoterms property.
	 * 
	 * @param value
	 *           allowed object is {@link JAXBElement }{@code <}{@link String }{@code >}
	 * 
	 */
	public void setInIncoterms(final JAXBElement<String> value)
	{
		this.inIncoterms = value;
	}
