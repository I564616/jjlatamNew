...
/**
 * <p>
 * Java class for ElectronicNotaFiscalRequest complex type.
 * 
 * <p>
...
@XmlType(name = "ElectronicNotaFiscalRequest", propOrder =
{ "header", "payLoad" })
@XmlRootElement(name = "ElectronicNotaFiscalRequest")
public class ElectronicNotaFiscalRequest
{
	 ...
	 * 
	 * @return possible object is {@link NFERequestData }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *           allowed object is {@link NFERequestData }
	 * 
	 */
	public void setPayLoad(final NFERequestData value)
	{
		this.payLoad = value;
	}
