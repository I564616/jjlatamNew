 ...
 *  
 */
package com.jnj.b2b.common.jalo;
...
import com.jnj.b2b.common.constants.JnjcommonConstants;



/**
 * This is the extension manager of the Jnjcommon extension.
 */
public class JnjcommonManager extends GeneratedJnjcommonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjcommonManager.class.getName());
	 ...
	 */
	public static JnjcommonManager getInstance()
	{
		return (JnjcommonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjcommonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjcommonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjcommonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjcommonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjcommonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
