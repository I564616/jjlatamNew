 ...
 * @version 1.0
 */
public class JnjRegisterEmailContext extends CustomerEmailContext
{
	...
	public void init(final StoreFrontCustomerProcessModel storeFrontCustomerProcessModel, final EmailPageModel emailPageModel)
	{
		...
		put(EMAIL,
				jnjConfigService.getConfigValueById(Jnjb2bCoreConstants.Register.REGISTER_EMAIL_TO
						+ emailContextMap.get(COUNTRYISOCODE)));
