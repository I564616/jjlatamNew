...
/**
 * Populate the product data with the product's gallery images. It checks if product has materialBaseProduct as not null
 * fetch images from materialBaseProduct.
 * 
 * @author Accenture
 * @version 1.0
 */
public class JnjGTProductGalleryImagesPopulator<SOURCE extends ProductModel, TARGET extends ProductData> extends
