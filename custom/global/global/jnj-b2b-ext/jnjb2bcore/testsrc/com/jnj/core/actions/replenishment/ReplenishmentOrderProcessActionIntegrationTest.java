 ...
 *  
 */
package com.jnj.core.actions.replenishment;
...
@IntegrationTest
public class ReplenishmentOrderProcessActionIntegrationTest extends ServicelayerTest
{
	...
	public void beforeTest() throws Exception
	{
		...
		importCsv("/jnjb2bcore/test/testOrganizations.csv", "utf-8");
		importCsv("/jnjb2bcore/test/testB2BCommerceCart.csv", "utf-8");
	...
	public void testCloneCartAction() throws Exception
	{
		...
		Assert.assertEquals("ahertz", cartService.getSessionCart().getUser().getUid());
	...
	public void testPlaceOrderAction() throws Exception
	{
		...
		Assert.assertEquals("ahertz", sessionCart.getUser().getUid());
