...
public class JnjGTUOMValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
			...
			final Object model) throws FieldValueProviderException
	{
		...
		// Get Delivery GTIN
		final JnjGTVariantProductModel variantModel = jnjGTProductService.getDeliveryGTIN(productModel);
	...
	protected List<FieldValue> createFieldValue(final JnjGTVariantProductModel variantModel, final IndexedProperty indexedProperty)
	{
		...
		// Populate ship UOM
		if (variantModel.getUnit() != null)
		{
			value.append(variantModel.getUnit().getName()).append(Jnjb2bCoreConstants.Solr.COLON);
		}
		// Populate Defination of eaches
		if (variantModel.getNumerator() != null)
		{
			value.append(variantModel.getNumerator()).append(Jnjb2bCoreConstants.Solr.COLON);
		}
		//Populate UOM of eaches
		if (variantModel.getLwrPackagingLvlUom() != null)
		{
			value.append(variantModel.getLwrPackagingLvlUom().getName());
		}
