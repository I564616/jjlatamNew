...
public class JnjGTWeightProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
	...
	protected List<FieldValue> createFieldValue(final JnjGTVariantProductModel variantModel, final IndexedProperty indexedProperty)
	{
		...
		if (variantModel.getWeightQty() != null && variantModel.getWeightUom() != null)
		{
			value.append(variantModel.getWeightQty()).append(Jnjb2bCoreConstants.Solr.COLON)
					.append(variantModel.getWeightUom().getName());
		}
