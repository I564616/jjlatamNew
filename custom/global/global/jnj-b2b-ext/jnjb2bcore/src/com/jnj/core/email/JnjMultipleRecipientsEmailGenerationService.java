...
import com.jnj.core.constants.Jnjgtb2bMDDConstants.ProductWorkflows;
 ...
 * 
 */
public class JnjMultipleRecipientsEmailGenerationService extends DefaultEmailGenerationService
{
    @Autowired
	 ...
	 */
	private static final Logger LOGGER = Logger.getLogger(JnjMultipleRecipientsEmailGenerationService.class);
			...
			final AbstractEmailContext<BusinessProcessModel> emailContext)
	{
        ...
        final EmailAddressModel toAddress = getEmailService().getOrCreateEmailAddressForEmail(JnJCommonUtil.getValue(ProductWorkflows.NEW_PRODUCT),
                JnJCommonUtil.getValue(ProductWorkflows.EXTERNAL_USER_GROUP_CA));
