...
public class JnjGTVolumeValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
	...
	protected List<FieldValue> createFieldValue(final JnjGTVariantProductModel variantModel, final IndexedProperty indexedProperty)
	{
		...
		if (variantModel.getVolumeQty() != null && variantModel.getVolumeUom() != null)
		{
			value.append(variantModel.getVolumeQty()).append(Jnjb2bCoreConstants.Solr.COLON)
					.append(variantModel.getVolumeUom().getName());
		}
