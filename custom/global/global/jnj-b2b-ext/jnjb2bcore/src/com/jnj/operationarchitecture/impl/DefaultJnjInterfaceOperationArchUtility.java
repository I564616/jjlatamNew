 ...
 * @version 1.0
 */
public class DefaultJnjInterfaceOperationArchUtility implements JnjInterfaceOperationArchUtility
{

	/**
	 * Constant LOGGER.
	 */
	private static final Logger LOGGER = Logger.getLogger(DefaultJnjInterfaceOperationArchUtility.class);
