...
/**
 * This is the extension manager of the Jnjutil extension.
 */
public class JnjutilManager extends GeneratedJnjutilManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjutilManager.class.getName());
	 ...
	 */
	public static JnjutilManager getInstance()
	{
		return (JnjutilManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjutilConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjutilManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjutilManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjutilManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjutilManager called, current tenant: " + getTenant().getTenantID());
		}
	}
