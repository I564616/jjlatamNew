...
import com.jnj.facades.constants.Jnjlab2bfacadesConstants;



/**
 * This is the extension manager of the Jnjlab2bfacades extension.
 */
public class Jnjlab2bfacadesManager extends GeneratedJnjlab2bfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Jnjlab2bfacadesManager.class.getName());
	 ...
	 */
	public static Jnjlab2bfacadesManager getInstance()
	{
		return (Jnjlab2bfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Jnjlab2bfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjlab2bfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Jnjlab2bfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Jnjlab2bfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Jnjlab2bfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
