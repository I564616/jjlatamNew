...
import com.jnj.la.pac.aera.constants.Jnjlatamb2bpacConstants;



/**
 * This is the extension manager of the Jnjlatamb2bpac extension.
 */
public class Jnjlatamb2bpacManager extends GeneratedJnjlatamb2bpacManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Jnjlatamb2bpacManager.class);
	 ...
	 */
	public static Jnjlatamb2bpacManager getInstance()
	{
		return (Jnjlatamb2bpacManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Jnjlatamb2bpacConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjlatamb2bpacManager() // NOPMD 
	{
		LOG.debug("constructor of Jnjlatamb2bpacManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Jnjlatamb2bpacManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Jnjlatamb2bpacManager called, current tenant: {}", getTenant().getTenantID());
	}
