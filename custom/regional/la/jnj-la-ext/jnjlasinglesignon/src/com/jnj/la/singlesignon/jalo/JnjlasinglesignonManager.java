 ...
 */
package com.jnj.la.singlesignon.jalo;
...
/**
 * This is the extension manager of the Jnjlasinglesignon extension.
 */
public class JnjlasinglesignonManager extends GeneratedJnjlasinglesignonManager
{
	private static final Logger LOG = Logger.getLogger(JnjlasinglesignonManager.class.getName());
	 ...
	 */
	public JnjlasinglesignonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlasinglesignonManager called.");
		}
	}
	 ...
	 */
	public static JnjlasinglesignonManager getInstance()
	{
		return (JnjlasinglesignonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlasinglesignonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlasinglesignonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlasinglesignonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
