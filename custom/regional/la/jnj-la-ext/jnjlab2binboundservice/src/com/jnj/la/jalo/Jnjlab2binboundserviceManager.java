...
/**
 * This is the extension manager of the Jnjlab2binboundservice extension.
 */
public class Jnjlab2binboundserviceManager extends GeneratedJnjlab2binboundserviceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Jnjlab2binboundserviceManager.class.getName());
	 ...
	 */
	public static Jnjlab2binboundserviceManager getInstance()
	{
		return (Jnjlab2binboundserviceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Jnjlab2binboundserviceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjlab2binboundserviceManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Jnjlab2binboundserviceManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Jnjlab2binboundserviceManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Jnjlab2binboundserviceManager called, current tenant: " + getTenant().getTenantID());
		}
	}
