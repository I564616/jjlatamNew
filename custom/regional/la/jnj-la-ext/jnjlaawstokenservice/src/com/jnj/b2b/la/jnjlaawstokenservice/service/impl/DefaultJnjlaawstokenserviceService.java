...
public class DefaultJnjlaawstokenserviceService implements JnjlaawstokenserviceService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultJnjlaawstokenserviceService.class);
