 ...
 */
package com.jnj.b2b.la.jnjlaawstokenservice.jalo;
...
/**
 * This is the extension manager of the Jnjlaawstokenservice extension.
 */
public class JnjlaawstokenserviceManager extends GeneratedJnjlaawstokenserviceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(JnjlaawstokenserviceManager.class);
	 ...
	 */
	public static JnjlaawstokenserviceManager getInstance()
	{
		return (JnjlaawstokenserviceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(JnjlaawstokenserviceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlaawstokenserviceManager() // NOPMD 
	{
		LOG.debug("constructor of JnjlaawstokenserviceManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of JnjlaawstokenserviceManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of JnjlaawstokenserviceManager called, current tenant: {}", getTenant().getTenantID());
	}
