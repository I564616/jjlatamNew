 ...
 */
package com.jnj.outboundservice.jalo;
...
/**
 * This is the extension manager of the Jnjlab2boutboundservice extension.
 */
public class Jnjlab2boutboundserviceManager extends GeneratedJnjlab2boutboundserviceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Jnjlab2boutboundserviceManager.class.getName());
	 ...
	 */
	public static Jnjlab2boutboundserviceManager getInstance()
	{
		return (Jnjlab2boutboundserviceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Jnjlab2boutboundserviceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjlab2boutboundserviceManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Jnjlab2boutboundserviceManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Jnjlab2boutboundserviceManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Jnjlab2boutboundserviceManager called, current tenant: " + getTenant().getTenantID());
		}
	}
