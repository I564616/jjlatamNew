...
/**
 * <p>
 * Java class for SalesOrder_Out2 complex type.
 *
 * <p>
 * The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="SalesOrder_Out2">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="out_SalesOrderNumber" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="out_orderLines" type="{http://itsusmpl00082.jnj.com/SG910_BtB_IN0498_SalesOrder_Global_Source_v1.webService:salesOrderWS}out_orderLines2" maxOccurs="unbounded"/>
 ...
 *         &lt;element name="Message_return" type="{http://itsusmpl00082.jnj.com/SG910_BtB_IN0498_SalesOrder_Global_Source_v1.webService:salesOrderWS}Message_return2" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SalesOrder_Out2", propOrder =
...
@XmlRootElement(name = "SalesOrderOut2")
public class SalesOrderOut2
{
	...
	protected List<OutOrderLines2> outOrderLines;
	...
	protected List<MessageReturn2> messageReturn;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link OutOrderLines2 }
	 * 
	 * 
	 */
	public List<OutOrderLines2> getOutOrderLines()
	{
		if (outOrderLines == null)
		{
			outOrderLines = new ArrayList<OutOrderLines2>();
		}
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link MessageReturn2 }
	 * 
	 * 
	 */
	public List<MessageReturn2> getMessageReturn()
	{
		if (messageReturn == null)
		{
			messageReturn = new ArrayList<MessageReturn2>();
		}
