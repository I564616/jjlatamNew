 ...
 * @version 1.0
 */
public interface JnjSellOutReportsService
{
	/**
	 *
	 ...
	 * @param sortflag
	 * @param pageableData
	 * @return List<JnjSellOutReportModel>
	 */
	 ...
	 * @return boolean
	 */
	public boolean updateUploadHistory(JnjSellOutReportModel jnjSellOutReportModel);
