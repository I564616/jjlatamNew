...
public class JnjUomConversionDTO
{
	...
	private String unitOfDimensionForVol;
	...
	/**
	 * @return the unitOfDimensionForVol
	 */
	public String getUnitOfDimensionForVol()
	{
		return unitOfDimensionForVol;
	}

	/**
	 * @param unitOfDimensionForVol
	 *           the unitOfDimensionForVol to set
	 */
	public void setUnitOfDimensionForVol(final String unitOfDimensionForVol)
	{
		this.unitOfDimensionForVol = unitOfDimensionForVol;
	}
	...
	/**
	 * @param shippingUnit
	 *           the shippingUnit to set
	 */
	public void setShippingUnit(final String shippingUnit)
	{
