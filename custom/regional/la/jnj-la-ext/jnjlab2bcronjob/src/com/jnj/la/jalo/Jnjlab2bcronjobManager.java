...
import com.jnj.la.constants.Jnjlab2bcronjobConstants;



/**
 * This is the extension manager of the Jnjlab2bcronjob extension.
 */
public class Jnjlab2bcronjobManager extends GeneratedJnjlab2bcronjobManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Jnjlab2bcronjobManager.class.getName());
	 ...
	 */
	public static Jnjlab2bcronjobManager getInstance()
	{
		return (Jnjlab2bcronjobManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Jnjlab2bcronjobConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjlab2bcronjobManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Jnjlab2bcronjobManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Jnjlab2bcronjobManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Jnjlab2bcronjobManager called, current tenant: " + getTenant().getTenantID());
		}
	}
