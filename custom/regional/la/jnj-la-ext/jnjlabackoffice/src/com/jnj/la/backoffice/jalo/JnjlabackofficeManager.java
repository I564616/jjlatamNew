 ...
 */
package com.jnj.la.backoffice.jalo;
...
import com.jnj.la.backoffice.constants.JnjlabackofficeConstants;
 ...
 */
public class JnjlabackofficeManager extends GeneratedJnjlabackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(JnjlabackofficeManager.class.getName());
	 ...
	 */
	public static JnjlabackofficeManager getInstance()
	{
		return (JnjlabackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(JnjlabackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlabackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlabackofficeManager called.");
		}
	}
