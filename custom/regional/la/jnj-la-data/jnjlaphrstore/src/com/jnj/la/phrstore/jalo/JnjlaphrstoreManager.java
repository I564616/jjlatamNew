 ...
 */
package com.jnj.la.phrstore.jalo;
...
import com.jnj.la.phrstore.constants.JnjlaphrstoreConstants;



/**
 * This is the extension manager of the Jnjlaphrstore extension.
 */
public class JnjlaphrstoreManager extends GeneratedJnjlaphrstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlaphrstoreManager.class.getName());
	 ...
	 */
	public static JnjlaphrstoreManager getInstance()
	{
		return (JnjlaphrstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlaphrstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlaphrstoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlaphrstoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlaphrstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlaphrstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
