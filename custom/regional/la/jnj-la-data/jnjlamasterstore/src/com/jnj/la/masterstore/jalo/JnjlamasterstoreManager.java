 ...
 */
package com.jnj.la.masterstore.jalo;
...
import com.jnj.la.masterstore.constants.JnjlamasterstoreConstants;



/**
 * This is the extension manager of the Jnjlamasterstore extension.
 */
public class JnjlamasterstoreManager extends GeneratedJnjlamasterstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlamasterstoreManager.class.getName());
	 ...
	 */
	public static JnjlamasterstoreManager getInstance()
	{
		return (JnjlamasterstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlamasterstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlamasterstoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlamasterstoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlamasterstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlamasterstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
