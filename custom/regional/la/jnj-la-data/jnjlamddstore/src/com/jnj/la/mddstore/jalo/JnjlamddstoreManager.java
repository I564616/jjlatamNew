 ...
 */
package com.jnj.la.mddstore.jalo;
...
import com.jnj.la.mddstore.constants.JnjlamddstoreConstants;



/**
 * This is the extension manager of the Jnjlamddstore extension.
 */
public class JnjlamddstoreManager extends GeneratedJnjlamddstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlamddstoreManager.class.getName());
	 ...
	 */
	public static JnjlamddstoreManager getInstance()
	{
		return (JnjlamddstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlamddstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlamddstoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlamddstoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlamddstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlamddstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
