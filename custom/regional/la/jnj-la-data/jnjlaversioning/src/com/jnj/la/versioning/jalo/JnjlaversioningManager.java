 ...
 */
package com.jnj.la.versioning.jalo;
...
import com.jnj.la.versioning.constants.JnjlaversioningConstants;



/**
 * This is the extension manager of the Jnjlaversioning extension.
 */
public class JnjlaversioningManager extends GeneratedJnjlaversioningManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlaversioningManager.class.getName());
	 ...
	 */
	public JnjlaversioningManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlaversioningManager called.");
		}
	}
	 ...
	 */
	public static JnjlaversioningManager getInstance()
	{
		return (JnjlaversioningManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlaversioningConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlaversioningManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlaversioningManager called, current tenant: " + getTenant().getTenantID());
		}
	}
