 ...
 *  
 */
package com.jnj.la.b2b.jnjglobalreports.jalo;
...
import com.jnj.la.b2b.jnjglobalreports.constants.JnjlaglobalreportsaddonConstants;



/**
 * This is the extension manager of the Jnjlaglobalreportsaddon extension.
 */
public class JnjlaglobalreportsaddonManager extends GeneratedJnjlaglobalreportsaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlaglobalreportsaddonManager.class.getName());
	 ...
	 */
	public static JnjlaglobalreportsaddonManager getInstance()
	{
		return (JnjlaglobalreportsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlaglobalreportsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlaglobalreportsaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlaglobalreportsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlaglobalreportsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlaglobalreportsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
