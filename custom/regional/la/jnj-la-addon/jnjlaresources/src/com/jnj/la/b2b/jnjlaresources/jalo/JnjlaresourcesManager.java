 ...
 *  
 */
package com.jnj.la.b2b.jnjlaresources.jalo;
...
import com.jnj.la.b2b.jnjlaresources.constants.JnjlaresourcesConstants;



/**
 * This is the extension manager of the Jnjlaresources extension.
 */
public class JnjlaresourcesManager extends GeneratedJnjlaresourcesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlaresourcesManager.class.getName());
	 ...
	 */
	public static JnjlaresourcesManager getInstance()
	{
		return (JnjlaresourcesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlaresourcesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlaresourcesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlaresourcesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlaresourcesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlaresourcesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
