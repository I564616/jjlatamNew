 ...
 *  
 */
package com.jnj.b2b.la.jnjlaprofileaddon.jalo;
...
/**
 * This is the extension manager of the Jnjlaprofileaddon extension.
 */
public class JnjlaprofileaddonManager extends GeneratedJnjlaprofileaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlaprofileaddonManager.class.getName());
	 ...
	 */
	public static JnjlaprofileaddonManager getInstance()
	{
		return (JnjlaprofileaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlaprofileaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlaprofileaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlaprofileaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlaprofileaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlaprofileaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
