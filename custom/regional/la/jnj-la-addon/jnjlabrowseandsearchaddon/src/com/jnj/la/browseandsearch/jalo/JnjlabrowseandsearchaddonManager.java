 ...
 *  
 */
package com.jnj.la.browseandsearch.jalo;
...
/**
 * This is the extension manager of the Jnjlabrowseandsearchaddon extension.
 */
public class JnjlabrowseandsearchaddonManager extends GeneratedJnjlabrowseandsearchaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlabrowseandsearchaddonManager.class.getName());
	 ...
	 */
	public static JnjlabrowseandsearchaddonManager getInstance()
	{
		return (JnjlabrowseandsearchaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlabrowseandsearchaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlabrowseandsearchaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlabrowseandsearchaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlabrowseandsearchaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlabrowseandsearchaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
