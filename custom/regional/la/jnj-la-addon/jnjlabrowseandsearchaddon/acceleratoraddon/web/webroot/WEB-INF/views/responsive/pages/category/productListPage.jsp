		...
		<div class="col-lg-12 col-md-12 catalogLanding">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
						<div class="d-none d-sm-block table-padding"><c:set value="${'MDD' eq JNJ_SITE_NAME ? true : false}" var="isMddSite"></c:set>
						...
						<div class="flitersPanel text-left padding10px" style="display:none;">
							<a data-bs-toggle="collapse" data-bs-parent="#accordion"	href="#collapse1" class="ref_no toggle-link panel-collapsed skyBlue">
								<table>
									<tbody>
										<tr>
											<td class="padding0"><i class="bi bi-plus-lg" style="-webkit-text-stroke: 2px;"></i></td>
							...
							<div id="collapse1" class="panel-collapse collapse">
											<div class="panel-body details col-lg-12 col-xs-12 col-sm-12 col-md-12 d-flex pt-4 paddingforcollapse ">
			...
			<div class="row Subcontainer d-block d-sm-none">
										...
										<div class="flitersPanel-mobile text-left padding0" style="background-color:white;border-top:1px solid #f2f2f2">
														<a data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapse2" class="ref_no toggle-link panel-collapsed skyBlue">
														<table style="margin-top:10px">
															<tbody>
																<tr>
																	<td class="padding0"><i class="bi bi-plus-lg"></i></a></td>
																	<td class="paddingforText"><spring:message code="product.search.ShowFilters" /></td>
																</tr>
															</tbody>
														</table>
														...
														<div class="pull-right downloadlinks downloadLinksSearchResults">
															<form:form id="searchSortForm" name="searchSortForm" method="POST"  modelAttribute="searchSortForm" >
																<input type="hidden" name="fullCount" value="${searchPageData.pagination.totalNumberOfResults}" >
