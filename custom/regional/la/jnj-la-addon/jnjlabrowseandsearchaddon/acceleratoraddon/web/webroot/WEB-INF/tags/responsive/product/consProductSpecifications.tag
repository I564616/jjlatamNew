...
<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 oddcolor">
	...
	<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12"><fmt:formatDate pattern="MM/dd/yyyy" value="${product.consumerSpecification.shippingInfo.shipEffectiveDate}" /></div></br>
