 ...
 *  
 */
package com.jnj.la.b2b.cartandcheckoutaddon.jalo;
...
import com.jnj.la.b2b.cartandcheckoutaddon.constants.JnjlacartandcheckoutaddonConstants;



/**
 * This is the extension manager of the Jnjlacartandcheckoutaddon extension.
 */
public class JnjlacartandcheckoutaddonManager extends GeneratedJnjlacartandcheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlacartandcheckoutaddonManager.class.getName());
	 ...
	 */
	public static JnjlacartandcheckoutaddonManager getInstance()
	{
		return (JnjlacartandcheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlacartandcheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlacartandcheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlacartandcheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlacartandcheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlacartandcheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
