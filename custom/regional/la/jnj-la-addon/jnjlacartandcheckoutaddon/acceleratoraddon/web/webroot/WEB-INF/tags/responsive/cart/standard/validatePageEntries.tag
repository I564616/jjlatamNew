...
<div class="orderDetailPanel validateStandard consumer">
        	<div class="orderDetHead noBorderBtm reviewOrder">
                ...
                <div class="hcolumn4"><span><spring:message code="cart.validate.quantity"/></span></div>
          ...
          <c:url value="${entry.product.url}" var="productUrl"/>
            ...
            <div id="orderentry-${count.count}" class="orderDetRow ${orderEntriesClass}">
				...
				<div class="floatLeft column2">
						<standardCart:productConsumerValidation entry="${entry}" showExpectedDeliveryDate="true" />
                </div>
