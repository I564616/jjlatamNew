          ...
          <c:url value="${entry.product.url}" var="productUrl"/>
            ...
            <div id="orderentry-${count.count}" class="orderDetRow ${orderEntriesClass}">
                ...
                <div class="floatLeft column3">
					<div class="lbox">
						<p><span>${entry.quantity}&nbsp${entry.product.deliveryUnit}</span></p>
						<p><label class="descSmall block" for="quantOne"> <spring:message code="product.multiple" />&nbsp;${entry.product.multiplicity}</label></p>
