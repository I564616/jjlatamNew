...
<input id="contractHeaderActive" value="${contractData.active}" type="hidden"/>
	<div id="ContractDetailsPage"> 
		...
		<div class="row">
			<div class="col-xs-12 headingTxt content"><spring:message code="contract.myContracts"/></div>
		</div>
 ...
 <%--	<div id="globalMessages">
	...
	<div class="row jnj-body-padding shipmentContainer" id="jnj-body-content"> --%>
					...
					<div class="col-lg-12 col-md-12">
						<div class="row jnj-panel-header">											
							<div class="col-lg-8 col-md-8 col-sm-6 col-xs-11">
								<div class="contract-label-head"><spring:message code="contract.contractNumber"/></div>
							...
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" id="download-link">
								<span class="pull-right"><span class="link-txt boldtext"><spring:message code="text.download"/></span>
								<a class="tertiarybtn contractDetailExcel" href="#" id ="contractExcelDownload" ><spring:message code="contract.excel.label"/></a>  
								<span class="pipesymbol">|</span> &nbsp; 
								<a class="tertiarybtn contractDetailPdf" href="#" id ="contractPdfDownload" ><spring:message code="contract.pdf.label"/></a></span>
							</div>	
						</div>
						<div class="row jnj-panel-body">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 contract-leftTotop-content">
								<div class="contract-content-holder">
									<div class="contract-label-head text-uppercase"><spring:message code="contract.indirectCustomer"/></div>
									<div class="contract-content">${contractData.indirectCustomer}</div>
								</div>
								<div class="contract-content-holder">
									<div class="text-uppercase contract-cutom-name-label"><spring:message code="contract.indirectCustomerName"/></div>
							...
							<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 contract-rightTobottom-content row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="contract-content-holder">
										<div class="contract-label-head text-uppercase"><spring:message code="contract.status"/></div>
										<div class="contract-content contract-content-active">
											<strong>
											<c:choose>
												<c:when test="${contractData.active}"><span class="active"><spring:message code="contract.status.active"/></span></c:when>
												<c:otherwise><span class="inactive"><spring:message code="contract.status.inactive"/></span></c:otherwise>
											</c:choose>
										</strong>
									</div>
									</div>
									<div class="contract-content-holder">
										<div class="contract-label-head text-uppercase"><spring:message code="contract.tenderNumber"/></div>
										<div class="contract-content">${contractData.tenderNum}</div>
									</div>
									<div class="contract-content-holder">
										<div class="contract-label-head text-uppercase"><spring:message code="contract.contractType"/></div>
										<div class="contract-content">${contractData.contractOrderReason}</div>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="contract-content-holder">
										<div class="contract-label-head text-uppercase"><spring:message code="contract.creationDate"/></div>
										<c:choose>
											<c:when test="${'en' eq sessionlanguage}">
												<div class="contract-content"><fmt:formatDate value="${contractData.startDate}" pattern="MM/dd/yyyy"/>&nbsp;</div>
											</c:when>
											<c:otherwise>
											 <div class="contract-content"><fmt:formatDate value="${contractData.startDate}" pattern="dd/MM/yyyy"/>&nbsp;</div>
											</c:otherwise>
										</c:choose>
									</div>
									<div class="contract-content-holder">
										<div class="contract-label-head text-uppercase"><spring:message code="contract.expirationDate"/></div>
										<c:choose>
											<c:when test="${'en' eq sessionlanguage}">
												<div class="contract-content"><fmt:formatDate value="${contractData.endDate}" pattern="MM/dd/yyyy"/>&nbsp;</div>
											</c:when>
											<c:otherwise>
											 <div class="contract-content"><fmt:formatDate value="${contractData.endDate}" pattern="dd/MM/yyyy"/>&nbsp;</div>
											</c:otherwise>
										</c:choose>
									</div>
									<div class="contract-content-holder">
										<div class="contract-label-head text-uppercase"><spring:message code="contract.detail.lasttimeupdated"/></div>
										<c:choose>
											<c:when test="${'en' eq sessionlanguage}">
												<div class="contract-content"><fmt:formatDate value="${contractData.lastUpdatedTime}" pattern="MM/dd/yyyy - hh:mm:ss"  timeZone="${timezoneSet}"/>&nbsp;</div>
											</c:when>
											<c:otherwise>
									...
									<c:if test="${contractData.documentType == 'ZCV'}">
										<div class="contract-content-holder">
											<div class="contract-label-head text-uppercase"><spring:message code="contract.totalValue"/>:</div>
											<div class="contract-content"><format:price priceData="${cntrctPriceData.totalAmount}" hideZeroValue="true"/>&nbsp;</div>
										</div>
										<div class="contract-content-holder">
											<div class="contract-label-head text-uppercase"><spring:message code="contract.consumedValue"/>:</div>
											<div class="contract-content"><format:price priceData="${cntrctPriceData.consumedAmount}"/>&nbsp;</div>
										</div>
										<div class="contract-content-holder">
											<div class="contract-label-head text-uppercase"><spring:message code="contract.contractBalance"/>:</div>
								...
								<td class="vlign-top orderno">
									<div class="display-table-row">
										...
										<div class="display-table-cell" style="vertical-align:top">
											...
											<a data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapse1" class="toggle-link panel-collapsed skyBlue ipadacctoggle">
											<div class="display-table-row">
				...
				<accountLa:contractEntries documentType="${contractData.documentType}"/>
			 </div> 
</templateLa:page>
