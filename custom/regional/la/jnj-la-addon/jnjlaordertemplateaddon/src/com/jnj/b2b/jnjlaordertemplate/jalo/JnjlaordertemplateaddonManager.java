 ...
 *  
 */
package com.jnj.b2b.jnjlaordertemplate.jalo;
...
/**
 * This is the extension manager of the Jnjlaordertemplateaddon extension.
 */
public class JnjlaordertemplateaddonManager extends GeneratedJnjlaordertemplateaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlaordertemplateaddonManager.class.getName());
	 ...
	 */
	public static JnjlaordertemplateaddonManager getInstance()
	{
		return (JnjlaordertemplateaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlaordertemplateaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlaordertemplateaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlaordertemplateaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlaordertemplateaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlaordertemplateaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
