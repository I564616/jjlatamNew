...
/**
 * This is the extension manager of the Jnjlaservicepageaddon extension.
 */
public class JnjlaservicepageaddonManager extends GeneratedJnjlaservicepageaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlaservicepageaddonManager.class.getName());
	 ...
	 */
	public static JnjlaservicepageaddonManager getInstance()
	{
		return (JnjlaservicepageaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlaservicepageaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlaservicepageaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlaservicepageaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlaservicepageaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlaservicepageaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
