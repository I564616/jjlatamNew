 ...
 *  
 */
package com.jnj.b2b.la.loginaddon.jalo;
...
/**
 * This is the extension manager of the Jnjlaloginaddon extension.
 */
public class JnjlaloginaddonManager extends GeneratedJnjlaloginaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JnjlaloginaddonManager.class.getName());
	 ...
	 */
	public static JnjlaloginaddonManager getInstance()
	{
		return (JnjlaloginaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JnjlaloginaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JnjlaloginaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JnjlaloginaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JnjlaloginaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JnjlaloginaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
