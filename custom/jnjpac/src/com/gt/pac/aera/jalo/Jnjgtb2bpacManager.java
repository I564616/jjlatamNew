...
/**
 * This is the extension manager of the Jnjgtb2bpac extension.
 */
public class Jnjgtb2bpacManager extends GeneratedJnjgtb2bpacManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Jnjgtb2bpacManager.class);
	 ...
	 */
	public static Jnjgtb2bpacManager getInstance()
	{
		return (Jnjgtb2bpacManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Jnjgtb2bpacConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjgtb2bpacManager() // NOPMD 
	{
		LOG.debug("constructor of Jnjgtb2bpacManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Jnjgtb2bpacManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Jnjgtb2bpacManager called, current tenant: {}", getTenant().getTenantID());
	}
